...
public class Class38 {
	public static Class26 aClass26_769;
	public static Class26 aClass26_772 = RS2Font.getRs2PreparedString(
			"scrollbar", false);
	...
	static {
		aClass26_769 = RS2Font.getRs2PreparedString("Standort", false);
		anInt770 = 0;
	}

	public static Class26 method919(int arg0, RSInterface arg1, int arg2) {
		try {
			anInt771++;
			...
			if (arg0 != -10706)
				method921(59);
			if (arg1.aClass26Array2247 == null
					|| ((arg1.aClass26Array2247.length ^ 0xffffffff) >= (arg2 ^ 0xffffffff))
					|| arg1.aClass26Array2247[arg2] == null
					|| (arg1.aClass26Array2247[arg2].method815(126).method825(
							-106) == 0)) {
				if (Class19_Sub1.aBoolean2538)
					return (Class4_Sub24.method639(
							new Class26[] { Class24.aClass26_551,
									Class74.method1168(-67, arg2) },
							arg0 + 9864));
				return null;
			}
			return arg1.aClass26Array2247[arg2];
