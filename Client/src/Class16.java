...
public class Class16 {
	...
	public static Class26 aClass26_432;
	public static Class26 aClass26_434;
	public static Class26 aClass26_437 = RS2Font.getRs2PreparedString(
			"Loading textures )2 ", false);
	public static Class26 aClass26_445;
	public static Class26 aClass26_450;
	public static Class26 aClass26_451;
	...
	static {
		aClass26_432 = aClass26_437;
		aClass26_445 = RS2Font.getRs2PreparedString("<col=00ff80>", false);
		aClass26_451 = RS2Font.getRs2PreparedString("rect_debug=", false);
		aClass26_450 = RS2Font.getRs2PreparedString("Walk here", false);
		aClass26_434 = aClass26_450;
	...
	public static void method721(int arg0, Class4_Sub14 arg1) {
		try {
			...
			if (class4_sub20_sub16 != null) {
				...
				try {
					RSCanvas.aClass26Array59 = new Class26[class4_sub20_sub16.anInt3163];
					...
					for (int i_17_ = arg0; (i_17_ ^ 0xffffffff) > (objects.length ^ 0xffffffff); i_17_++) {
						if (!(objects[i_17_] instanceof Integer)) {
							if (objects[i_17_] instanceof Class26) {
								Class26 class26 = (Class26) objects[i_17_];
								if (class26.method802(1,
										(Class4_Sub20_Sub10.aClass26_3071)))
									class26 = arg1.aClass26_2276;
								RSCanvas.aClass26Array59[i_16_++] = class26;
							}
						} else {
					...
					for (;;) {
						...
						if ((i_13_ ^ 0xffffffff) > -101) {
							...
							if (i_13_ == 3) {
								Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (class4_sub20_sub16.aClass26Array3178[i_12_]);
								continue;
							}
							if (i_13_ == 6) {
								i_12_ += is[i_12_];
							...
							if ((i_13_ ^ 0xffffffff) == -22) {
								if ((Class31.anInt669 ^ 0xffffffff) != -1) {
									...
									RSCanvas.aClass26Array59 = class59.aClass26Array1177;
							...
							if ((i_13_ ^ 0xffffffff) == -36) {
								Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = RSCanvas.aClass26Array59[is[i_12_]];
								continue;
							}
							if ((i_13_ ^ 0xffffffff) == -37) {
								RSCanvas.aClass26Array59[is[i_12_]] = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
								continue;
							}
							if (i_13_ == 37) {
								int i_24_ = is[i_12_];
								i_11_ -= i_24_;
								Class26 class26 = Class64.method1065(
										arg0 ^ 0x4f, i_24_, i_11_,
										(Class4_Sub11_Sub1.aClass26Array2673));
								Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
								continue;
							}
							if (i_13_ == 38) {
								i_10_--;
							...
							if (i_13_ == 40) {
								...
								Class26[] class26s = (new Class26[class4_sub20_sub16_26_.anInt3163]);
								...
								for (int i_29_ = 0; ((i_29_ ^ 0xffffffff) > (class4_sub20_sub16_26_.anInt3168 ^ 0xffffffff)); i_29_++)
									class26s[i_29_] = (Class4_Sub11_Sub1.aClass26Array2673[(i_29_
								...
								class59.aClass26Array1177 = RSCanvas.aClass26Array59;
								...
								RSCanvas.aClass26Array59 = class26s;
								is_14_ = class4_sub20_sub16.anIntArray3182;
								continue;
							}
							...
							if (i_13_ == 47) {
								Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2671[is[i_12_]]);
								if (class26 == null)
									class26 = Class80.aClass26_1648;
								Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
								continue;
							}
							if (i_13_ == 48) {
								Class4_Sub11_Sub1.aClass26Array2671[is[i_12_]] = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
								continue;
							}
						}
						boolean bool;
						...
						if (i_13_ < 1000) {
							...
							if (((i_13_ ^ 0xffffffff) <= -1101 && (i_13_ ^ 0xffffffff) > -1201)
								...
								if (i_13_ == 1100) {
									...
									Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
									if (!class26.method802(1,
											(class4_sub13.aClass26_2150))) {
										class4_sub13.aClass26_2150 = class26;
										Class67.method1088(class4_sub13, 0);
									}
								...
								if ((i_13_ ^ 0xffffffff) == -1301) {
									...
									if (i_50_ < 0 || (i_50_ ^ 0xffffffff) < -10)
										...
										class4_sub13
												.method294(
														arg0,
														i_50_,
														(Class4_Sub11_Sub1.aClass26Array2673[--i_11_]));
								} else if (i_13_ == 1301) {
									i_10_ -= 2;
									...
									class4_sub13.aClass26_2196 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
								else if (i_13_ == 1306)
									class4_sub13.aClass26_2174 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
								else {
									if ((i_13_ ^ 0xffffffff) != -1308)
										break;
									class4_sub13.aClass26Array2247 = null;
								}
							} else if (i_13_ >= 1400
									&& i_13_ < 1500
								...
								Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
								int[] is_53_ = null;
								if ((class26.method825(-106) ^ 0xffffffff) < -1
										&& ((class26.method834(21340, -1
												+ class26.method825(-117))) ^ 0xffffffff) == -90) {
									...
									class26 = (class26.method829((byte) 16, 0,
											-1 + class26.method825(-127)));
								}
								Object[] objects_55_ = new Object[class26
										.method825(-114) + 1];
								for (int i_56_ = objects_55_.length + -1; (i_56_ ^ 0xffffffff) <= -2; i_56_--) {
									if ((class26.method834(arg0 ^ 0x535d, i_56_
											+ -1) ^ 0xffffffff) == -116)
										objects_55_[i_56_] = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
									else
									...
									if ((i_13_ ^ 0xffffffff) <= -1801) {
										if (i_13_ < 1900) {
											...
											if (i_13_ == 1800)
												...
												i_58_--;
												if (((class4_sub13.aClass26Array2247) == null)
														|| ((i_58_ ^ 0xffffffff) <= ((class4_sub13.aClass26Array2247).length ^ 0xffffffff))
														|| (class4_sub13.aClass26Array2247[i_58_]) == null)
													Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub1.aClass26_2738);
												else
													Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (class4_sub13.aClass26Array2247[i_58_]);
											} else {
												if (i_13_ != 1802)
													break;
												if (class4_sub13.aClass26_2196 != null)
													Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (class4_sub13.aClass26_2196);
												else
													Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub1.aClass26_2738);
											}
										} else if (i_13_ < 2600) {
											...
											if (i_13_ == 2600)
												...
												Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (class4_sub13.aClass26_2150);
											else if (i_13_ == 2603)
											...
											if ((i_13_ ^ 0xffffffff) <= -2901) {
												if (i_13_ >= 3200) {
														...
														if (i_13_ < 3400) {
															...
															if ((i_13_ ^ 0xffffffff) == -3401) {
																...
																for (int i_83_ = 0; (((class4_sub20_sub5.anInt2875) ^ 0xffffffff) < (i_83_ ^ 0xffffffff)); i_83_++) {
																	if ((class4_sub20_sub5.anIntArray2870[i_83_]) == i_81_) {
																		Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class4_sub20_sub5.aClass26Array2877[i_83_];
																		class4_sub20_sub5 = null;
																		break;
																	}
																}
																if (class4_sub20_sub5 != null)
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (class4_sub20_sub5.aClass26_2878);
															} else {
																...
																if (((class4_sub20_sub5.anInt2874) != i_85_)
																	...
																	if (i_84_ != 115)
																		...
																		Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = Class80.aClass26_1648;
																} else {
																	for (int i_88_ = 0; ((class4_sub20_sub5.anInt2875) > i_88_); i_88_++) {
																		if ((class4_sub20_sub5.anIntArray2870[i_88_] ^ 0xffffffff) == (i_87_ ^ 0xffffffff)) {
																			if ((i_84_ ^ 0xffffffff) == -116)
																				Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class4_sub20_sub5.aClass26Array2877[i_88_];
																			else
															...
															if ((i_13_ ^ 0xffffffff) == -3601) {
																...
																if ((((Class11.anInt326) ^ 0xffffffff) == -3)
																	...
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub5.aClass26Array2893[i_89_]);
																else
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub1.aClass26_2738);
																...
																Class4_Sub11_Sub1
																		.method263(
																				(class26.method806((byte) -76)),
																				(arg0 + -315));
															} else if ((i_13_ ^ 0xffffffff) == -3607) {
																Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
																Class5.method641(
																		(class26.method806((byte) -33)),
																		(byte) 68);
															} else if ((i_13_ ^ 0xffffffff) == -3608) {
																Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
																Class48.method984(
																		(class26.method806((byte) -41)),
																		(byte) 0);
																...
																Class4_Sub24
																		.method638(
																				arg0 + 1,
																				(class26.method806((byte) -112)));
															} else if (i_13_ == 3609) {
																Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
																if ((class26
																		.method808(
																				(Class4_Sub2_Sub1.aClass26_2595),
																				(byte) -95))
																		|| (class26
																				.method808(
																						(Class4_Sub20_Sub17.aClass26_3210),
																						(byte) -95)))
																	class26 = (class26
																			.method805(
																					7,
																					113));
																Class24.anIntArray557[i_10_++] = ((Class26
																		.method830(
																				60,
																				class26)) ? 1
																		: 0);
															} else if (i_13_ == 3611) {
																if ((Class50.aClass26_1019) == null)
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub1.aClass26_2738);
																else
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class50.aClass26_1019);
																...
																if (((Class50.aClass26_1019) != null)
																	...
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class13_Sub2.aClass4_Sub8Array2482[i_93_].aClass26_1975);
																else
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub1.aClass26_2738);
															} else if (i_13_ == 3614) {
																...
																if ((Class11.anInt326) != 0)
																	Class24.anIntArray557[i_10_++] = (Class26.anInt1827);
																else
																	Class24.anIntArray557[i_10_++] = -1;
															} else {
																...
																if ((((Class11.anInt326) ^ 0xffffffff) != -1)
																		&& ((i_97_ ^ 0xffffffff) > ((Class26.anInt1827) ^ 0xffffffff)))
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = Class68
																			.method1094(
																					-5,
															...
															if ((i_13_ ^ 0xffffffff) > -4301) {
																if (i_13_ == 4200) {
																	...
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub23
																			.method633(
																					i_131_,
																					(byte) -121).aClass26_2991);
																	...
																	if ((i_133_ >= 1)
																			&& (i_133_ <= 5)
																			&& (class4_sub20_sub8.aClass26Array3008[-1
																					+ i_133_]) != null)
																		Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class4_sub20_sub8.aClass26Array3008[-1
																				+ i_133_];
																	else
																		Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = Class4_Sub20_Sub1.aClass26_2738;
																} else if (i_13_ == 4202) {
																	...
																	if (((i_135_ ^ 0xffffffff) <= -2)
																			&& (i_135_ <= 5)
																			&& (class4_sub20_sub8.aClass26Array2988[-1
																					+ i_135_]) != null)
																		Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class4_sub20_sub8.aClass26Array2988[i_135_
																				+ -1];
																	else
																		Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = Class4_Sub20_Sub1.aClass26_2738;
																...
																if ((i_13_ ^ 0xffffffff) == -5001)
																	...
																	Class26 class26 = null;
																	if (i_143_ < 100)
																		class26 = Class4_Sub2_Sub1.aClass26Array2574[i_143_];
																	if (class26 == null)
																		class26 = Class4_Sub20_Sub1.aClass26_2738;
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
																} else if (i_13_ == 5004) {
																	int i_144_ = (Class24.anIntArray557[--i_10_]);
																	int i_145_ = -1;
																	if ((i_144_ < 100)
																			&& (Class4_Sub2_Sub1.aClass26Array2574[i_144_]) != null)
																	...
																	if (class26
																		...
																		Class13.anInt369++;
																		Class26 class26_146_ = class26
																				.method827((byte) -55);
																		int i_147_ = 0;
																		int i_148_ = 0;
																		if (class26_146_
																				.method808(
																						Class64.aClass26_1266,
																						(byte) -95)) {
																			i_147_ = 0;
																			class26 = class26
																					.method805(
																							Class64.aClass26_1266
																									.method825(arg0
																											^ ~0x78),
																							-46);
																		} else if (!class26_146_
																				.method808(
																						Class62.aClass26_1226,
																						(byte) -95)) {
																			if (class26_146_
																					.method808(
																							Class4_Sub24.aClass26_2442,
																							(byte) -95)) {
																				class26 = class26
																						.method805(
																								Class4_Sub24.aClass26_2442
																				...
																				class26 = class26
																					...
																					.method808(
																							Class4_Sub20_Sub4.aClass26_2853,
																							(byte) -95)) {
																				class26 = class26
																						.method805(
																								Class4_Sub20_Sub4.aClass26_2853
																				...
																				i_147_ = 4;
																					...
																					.method808(
																							Class14.aClass26_403,
																							(byte) -95)) {
																				if (class26_146_
																						.method808(
																								Class13_Sub2.aClass26_2474,
																								(byte) -95)) {
																					class26 = class26
																							.method805(
																									Class13_Sub2.aClass26_2474
																					...
																					i_147_ = 6;
																						...
																						.method808(
																								Class10.aClass26_295,
																								(byte) -95)) {
																					if (!class26_146_
																							.method808(
																									Class58.aClass26_1172,
																									(byte) -95)) {
																						if (!class26_146_
																								.method808(
																										Class4_Sub20_Sub11.aClass26_3094,
																										(byte) -95)) {
																							if (class26_146_
																									.method808(
																											Class6.aClass26_207,
																								...
																								if (!class26_146_
																										.method808(
																												Class64.aClass26_1260,
																												(byte) -95)) {
																									if (class26_146_
																											.method808(
																													Class62.aClass26_1236,
																													(byte) -95)) {
																										i_147_ = 1;
																										class26 = class26
																												.method805(
																											...
																											.method808(
																													Class4_Sub24.aClass26_2435,
																													(byte) -95)) {
																										if (!class26_146_
																												.method808(
																														Class41.aClass26_839,
																														(byte) -95)) {
																											if (class26_146_
																													.method808(
																															Class4_Sub20_Sub4.aClass26_2854,
																															(byte) -95)) {
																												i_147_ = 4;
																												class26 = class26
																														.method805(
																												...
																												i_147_ = 6;
																													...
																													.method808(
																															Class10.aClass26_297,
																															(byte) -95)) {
																												if (class26_146_
																														.method808(
																																Class58.aClass26_1166,
																																(byte) -95)) {
																													i_147_ = 8;
																													class26 = class26
																															.method805(
																														...
																														.method808(
																																Class4_Sub20_Sub11.aClass26_3095,
																																(byte) -95)) {
																													class26 = class26
																															.method805(
																																	Class4_Sub20_Sub11.aClass26_3095
																		...
																		class26_146_ = class26
																				.method827((byte) -55);
																		if (!class26_146_
																				.method808(
																						Class4_Sub20_Sub7_Sub1_Sub1.aClass26_3589,
																						(byte) -95)) {
																			if (!class26_146_
																					.method808(
																							Class4_Sub21.aClass26_2375,
																							(byte) -95)) {
																				if (class26_146_
																						.method808(
																								Class4_Sub11_Sub1.aClass26_2676,
																								(byte) -95)) {
																					i_148_ = 3;
																					class26 = class26
																							.method805(
																						...
																						.method808(
																								Class4_Sub20_Sub4.aClass26_2860,
																								(byte) -95)) {
																					class26 = class26
																							.method805(
																									Class4_Sub20_Sub4.aClass26_2860
																					...
																					i_148_ = 4;
																						...
																						.method808(
																								Class80.aClass26_1635,
																								(byte) -95)) {
																					if ((Class19_Sub1.anInt2536 ^ 0xffffffff) != -1) {
																						if (!class26_146_
																								.method808(
																										Class4_Sub20_Sub7_Sub1_Sub1.aClass26_3600,
																										(byte) -95)) {
																							if (!class26_146_
																									.method808(
																											Class4_Sub21.aClass26_2377,
																											(byte) -95)) {
																								if (!class26_146_
																										.method808(
																												Class4_Sub11_Sub1.aClass26_2669,
																												(byte) -95)) {
																									if (class26_146_
																											.method808(
																													Class4_Sub20_Sub4.aClass26_2852,
																													(byte) -95)) {
																										i_148_ = 4;
																										class26 = class26
																												.method805(
																	...
																	i_11_ -= 2;
																	Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[i_11_]);
																	Class26 class26_150_ = (Class4_Sub11_Sub1.aClass26Array2673[1 + i_11_]);
																	Class66.aClass4_Sub11_Sub1_1328
																			.method264(
																					238,
																					-47);
																	...
																	Class26 class26 = null;
																	if (i_152_ < 100)
																		class26 = Class13.aClass26Array385[i_152_];
																	if (class26 == null)
																		class26 = Class4_Sub20_Sub1.aClass26_2738;
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
																} else if (i_13_ == 5011) {
																	...
																	if ((i_153_ ^ 0xffffffff) > -101)
																		class26 = Class4_Sub20_Sub9.aClass26Array3046[i_153_];
																	if (class26 == null)
																		class26 = Class4_Sub20_Sub1.aClass26_2738;
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
																	...
																	if (((Class4_Sub15.aClass4_Sub20_Sub7_Sub1_Sub1_2302) != null)
																			&& (Class4_Sub15.aClass4_Sub20_Sub7_Sub1_Sub1_2302.aClass26_3593) != null)
																		class26 = Class4_Sub15.aClass4_Sub20_Sub7_Sub1_Sub1_2302.aClass26_3593;
																	else
																		class26 = Class34.aClass26_1768;
																	Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
															...
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
															Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub24
																	.method639(
																			(new Class26[] {
																					class26,
																					(Class74.method1168(
															...
															i_11_ -= 2;
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[1 + i_11_]);
															Class26 class26_155_ = (Class4_Sub11_Sub1.aClass26Array2673[i_11_]);
															Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub24
																	.method639(
																			(new Class26[] {
																					class26_155_,
																	...
																	.method639(
																			(new Class26[] {
																					(Class74.method1168(
																							-44,
																							i_158_)),
																					(Class42.aClass26_846),
																					(Class47.aClass26Array954[i_159_]),
																					(Class42.aClass26_846),
																					(Class74.method1168(
																							-102,
																							i_160_)) }),
															...
															i_11_ -= 2;
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[(i_11_ - -1)]);
															Class26 class26_161_ = (Class4_Sub11_Sub1.aClass26Array2673[i_11_]);
															if (((Class4_Sub15.aClass4_Sub20_Sub7_Sub1_Sub1_2302.aClass35_3609) == null)
																...
																Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26_161_;
															else
																Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
														} else if ((i_13_ ^ 0xffffffff) == -4107) {
															int i_162_ = (Class24.anIntArray557[--i_10_]);
															Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class74
																	.method1168(
																			-86,
																			i_162_));
														} else if (i_13_ == 4107) {
															i_11_ -= 2;
															Class24.anIntArray557[i_10_++] = (Class4_Sub11_Sub1.aClass26Array2673[i_11_]
																	.method833(
																			(Class4_Sub11_Sub1.aClass26Array2673[1 + i_11_]),
																			-96));
															...
															i_11_ -= 2;
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[1 + i_11_]);
															Class26 class26_169_ = (Class4_Sub11_Sub1.aClass26Array2673[i_11_]);
															if (((Class24.anIntArray557[--i_10_]) ^ 0xffffffff) != -2)
																Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26;
															else
																Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26_169_;
														} else if ((i_13_ ^ 0xffffffff) == -4112) {
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
															Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub12_Sub4
																	.method574(class26));
														} else if (i_13_ == 4112) {
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
															...
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
															Class26 class26_177_ = (Class4_Sub10
																	.method205(
																			(byte) -99,
																			(class26.method825(arg0
																					+ -123))));
															boolean bool_178_ = false;
															for (int i_179_ = 0; ((class26
															...
															class26_177_
																	.method831(0);
															Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = class26_177_;
														} else {
															if (i_13_ != 4120)
																break;
															Class26 class26 = (Class4_Sub11_Sub1.aClass26Array2673[--i_11_]);
													...
													Class43.method955(
															class26,
															(Class4_Sub20_Sub1.aClass26_2738),
															(byte) 123, 0);
												...
												if (i_13_ == 2800)
													...
													i_189_--;
													if (((class4_sub13.aClass26Array2247) == null)
															|| (i_189_ >= (class4_sub13.aClass26Array2247).length)
															|| (class4_sub13.aClass26Array2247[i_189_]) == null)
														Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (Class4_Sub20_Sub1.aClass26_2738);
													else
														Class4_Sub11_Sub1.aClass26Array2673[i_11_++] = (class4_sub13.aClass26Array2247[i_189_]);
												} else {
					...
					if (class4_sub20_sub16.aClass26_3172 != null) {
						Class26 class26 = Class4_Sub10
								.method205((byte) -89, 30);
						class26.method832(RS2Font.aClass26_2770,
								(byte) -28).method832(
								class4_sub20_sub16.aClass26_3172, (byte) -28);
						for (int i_192_ = -1 + Class31.anInt669; i_192_ >= 0; i_192_--)
							class26.method832(Class66.aClass26_1334, (byte) -28)
									.method832(
											(Class42.aClass59Array849[i_192_].aClass4_Sub20_Sub16_1182.aClass26_3172),
											(byte) -28);
						if ((i_13_ ^ 0xffffffff) == -41) {
							int i_193_ = is[i_12_];
							class26.method832(Class5.aClass26_176, (byte) -28)
							...
							Class43.method955(
									Class4_Sub24
											.method639(
													(new Class26[] {
															Class2.aClass26_81,
															(class4_sub20_sub16.aClass26_3172) }),
													-842),
									Class4_Sub20_Sub1.aClass26_2738,
									(byte) 113, 0);
						Class4_Sub20_Sub7_Sub4.method422(
								...
								("CS2 - scr:" + class4_sub20_sub16.aLong150
										+ " op:" + i_13_ + new String(class26
										.method836(-10650))));
					} else {
						if (Class12.anInt341 != 0)
							Class43.method955(Class4_Sub2_Sub1.aClass26_2581,
									Class4_Sub20_Sub1.aClass26_2738,
									(byte) 117, 0);
