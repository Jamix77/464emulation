...
public class Class76 implements Runnable {
	...
	public static Class26 aClass26_1557;
	public static Class26 aClass26_1560 = RS2Font.getRs2PreparedString(
			" steht bereits auf Ihrer Freunde)2Liste(Q", false);
	public static Class26 aClass26_1561;
	public static Class26 aClass26_1563;
	public static Class26 aClass26_1564;
	public static Class26 aClass26_1566;
	public static Class26 aClass26_1579;
	public static AppletListener aClass70_1552;
	...
	static {
		anInt1550 = 0;
		aClass26_1557 = RS2Font.getRs2PreparedString("W-=hlen Sie eine Option",
				false);
		anIntArray1571 = new int[25];
		aClass26_1563 = RS2Font.getRs2PreparedString("Neuer Benutzer", false);
		aClass26_1566 = RS2Font.getRs2PreparedString("Free world", false);
		aClass26_1564 = RS2Font.getRs2PreparedString(" loggt sich aus)3", false);
		...
		aClass26_1561 = aClass26_1566;
		aClass70_1552 = new AppletListener();
		anInt1580 = 0;
		aClass26_1579 = RS2Font.getRs2PreparedString("blinken1:", false);
		anInt1581 = 0;
	...
	public static void method1182(int arg0) {
		anInt1569++;
		if (aClass70_1552 != null) {
			synchronized (aClass70_1552) {
				aClass70_1552 = null;
			}
		}
		if (arg0 >= -75)
	...
	public static Class26 method1185(int arg0, int arg1, boolean arg2, int arg3) {
		try {
