...
public class RSInterface extends RSFont {
	...
	public static Class26 aClass26_2249 = RS2Font.getRs2PreparedString(
			"Sichtbare Karte vorbereitet)3", false);
			...
			if ((i_13_ ^ 0xffffffff) < -1) {
				...
				for (int i_21_ = 0; i_21_ < 128; i_21_++) {
					...
					for (int i_23_ = -i_13_; i > i_23_; i_23_++) {
						int i_24_ = i_23_ * 128;
						if (i_23_ + i_13_ < i)
							i_22_ += (Class4_Sub20_Sub17.anIntArray3206[i_21_
									- -i_24_ - -(128 * i_13_)]);
						if ((-i_13_ + (-1 + i_23_) ^ 0xffffffff) <= -1)
							i_22_ -= (Class4_Sub20_Sub17.anIntArray3206[-128
									+ -(i_13_ * 128) + (i_24_ + i_21_)]);
						if ((i_23_ ^ 0xffffffff) <= -1)
							Class76.anIntArray1565[i_24_ + i_21_] = i_22_
									/ (2 * i_13_ + 1);
					}
				}
			}
	...
	public Class26 aClass26_2149;
	public Class26 aClass26_2150;
	public Class26 aClass26_2174;
	public Class26 aClass26_2196;
	public Class26 aClass26_2202;
	public Class26 aClass26_2264;
	public Class26[] aClass26Array2233;
	public Class26[] aClass26Array2247;
	...
	public RSInterface() {
		aClass26_2150 = Class4_Sub20_Sub7_Sub3.aClass26_3334;
		anInt2140 = 0;
		anInt2137 = 1;
		anInt2170 = -1;
		anInt2168 = 100;
		anInt2171 = 0;
		anInt2185 = 0;
		aClass26_2149 = Class4_Sub20_Sub7_Sub3.aClass26_3334;
		anInt2161 = 0;
		anInt2192 = 0;
		anInt2190 = 0;
		aBoolean2178 = false;
		aClass26_2174 = Class4_Sub20_Sub7_Sub3.aClass26_3334;
		aBoolean2165 = false;
		anInt2193 = -1;
		anInt2173 = -1;
		aClass26_2202 = Class4_Sub20_Sub7_Sub3.aClass26_3334;
		aClass26_2196 = Class4_Sub20_Sub7_Sub3.aClass26_3334;
		anInt2147 = -1;
		anInt2201 = 0;
		anInt2210 = -1;
		anInt2183 = -1;
		...
		aBoolean2263 = false;
		anInt2262 = 0;
		aClass26_2264 = Class50.aClass26_1011;
		aBoolean2253 = false;
		anInt2266 = 0;
	}
	...
	public void method283(int arg0, StreamBuffer arg1) {
		...
		if ((anInt2258 ^ 0xffffffff) == -3) {
			...
			aClass26Array2233 = new Class26[5];
			for (int i_38_ = 0; i_38_ < 5; i_38_++) {
				Class26 class26 = arg1.method212(96);
				if (class26.method825(arg0 ^ ~0x70) > 0) {
					aClass26Array2233[i_38_] = class26;
		...
		if (anInt2258 == 4) {
			aClass26_2150 = arg1.method212(81);
			aClass26_2149 = arg1.method212(122);
		}
		...
		if ((anInt2258 ^ 0xffffffff) == -8) {
			...
			for (int i_40_ = 0; i_40_ < 5; i_40_++) {
				Class26 class26 = arg1.method212(101);
				if ((class26.method825(-114) ^ 0xffffffff) < -1) {
					aClass26Array2233[i_40_] = class26;
					anInt2246 |= 1 << 23 - -i_40_;
				}
			}
		}
		if (anInt2258 == 8)
			aClass26_2150 = arg1.method212(101);
		if (anInt2171 == 2 || (anInt2258 ^ 0xffffffff) == -3) {
			aClass26_2174 = arg1.method212(arg0 ^ 0x58);
			aClass26_2202 = arg1.method212(arg0 + 117);
		...
		if ((anInt2171 ^ 0xffffffff) == -2 || (anInt2171 ^ 0xffffffff) == -5
			...
			aClass26_2264 = arg1.method212(82);
			if ((aClass26_2264.method825(-112) ^ 0xffffffff) == -1) {
				if ((anInt2171 ^ 0xffffffff) == -2)
					aClass26_2264 = Class50.aClass26_1011;
				if (anInt2171 == 4)
					aClass26_2264 = Class25.aClass26_586;
				if ((anInt2171 ^ 0xffffffff) == -6)
					aClass26_2264 = Class25.aClass26_586;
				if ((anInt2171 ^ 0xffffffff) == -7)
					aClass26_2264 = Class4_Sub20_Sub8.aClass26_2967;
			}
		}
		...
		try {
			...
			if (arg1 >= 27) {
				...
				if (anInt2258 == 4) {
					...
					if ((anInt2170 ^ 0xffffffff) == -65536)
						anInt2170 = -1;
					aClass26_2150 = arg0.method212(127);
					anInt2161 = arg0.get();
					anInt2214 = arg0.get();
					anInt2262 = arg0.get();
				...
				aClass26_2196 = arg0.method212(93);
				int i = arg0.get();
				if ((i ^ 0xffffffff) < -1) {
					aClass26Array2247 = new Class26[i];
					for (int i_43_ = 0; (i_43_ ^ 0xffffffff) > (i ^ 0xffffffff); i_43_++)
						aClass26Array2247[i_43_] = arg0.method212(78);
				}
				anInt2248 = arg0.get();
				anInt2198 = arg0.get();
				aBoolean2160 = (arg0.get() ^ 0xffffffff) == -2;
				aClass26_2174 = arg0.method212(112);
	...
	public void method294(int arg0, int arg1, Class26 arg2) {
		try {
			if (aClass26Array2247 == null
					|| (aClass26Array2247.length ^ 0xffffffff) >= (arg1 ^ 0xffffffff)) {
				Class26[] class26s = new Class26[1 + arg1];
				if (aClass26Array2247 != null) {
					for (int i = 0; ((i ^ 0xffffffff) > (aClass26Array2247.length ^ 0xffffffff)); i++)
						class26s[i] = aClass26Array2247[i];
				}
				aClass26Array2247 = class26s;
			}
			anInt2211++;
			if (arg0 != 1)
				method284(false, null);
			aClass26Array2247[arg1] = arg2;
		} catch (RuntimeException runtimeexception) {
