...
public class Class5 {
	...
	public static Class26 aClass26_179 = RS2Font.getRs2PreparedString(
			"Ihr Charakter)2Profil wird in:", false);
	public static Class26 aClass26_194 = null;
	public static Class26[] aClass26Array187;
	...
	static {
		...
		aClass26Array187 = new Class26[anInt193];
	...
	public static void method642(Class26 arg0, boolean arg1) {
		try {
			anInt171++;
			if (arg0.method818(
					RS2Font.getRs2PreparedString("::rdata", false),
					(byte) -105)) {
			...
			if ((Class14.anInt410 ^ 0xffffffff) <= -3) {
				if (arg0.method818(Class4_Sub21.garbageCollection, (byte) -105))
					System.gc();
				if (arg0.method818(Class27.aClass26_622, (byte) -105))
					Class11.method674(-1);
				if (arg0.method818(Class4_Sub20_Sub5.aClass26_2886, (byte) -105))
					Class4_Sub20_Sub9.aBoolean3048 = true;
				if (arg0.method818(Class30.aClass26_659, (byte) -105))
					Class4_Sub20_Sub9.aBoolean3048 = false;
				if (arg0.method818(Class7.aClass26_223, (byte) -105)) {
					for (int i = 0; i < 4; i++) {
				...
				if (arg0.method818(Class67.aClass26_1365, (byte) -105)
						&& Class12.anInt341 == 2)
					throw new RuntimeException();
				if (arg0.method808(Class74.aClass26_1520, (byte) -95)) {
					Class52.anInt1052 = arg0.method805(12, 86).method815(126)
							.method804((byte) -128);
					Class43.method955(
							(Class4_Sub24.method639(
									(new Class26[] {
											Class16.aClass26_451,
											Class74.method1168(-41,
													(Class52.anInt1052)) }),
									-842)), null, (byte) 118, 0);
				}
				if (arg0.method818(Class4_Sub20_Sub7_Sub4.aClass26_3368,
						(byte) -105))
