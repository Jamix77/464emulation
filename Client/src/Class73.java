...
public class Class73 {
	...
	public static Class26 aClass26_1499;
	public static Class26 aClass26_1501;
	public static Class26 aClass26_1503 = RS2Font.getRs2PreparedString("K",
			false);
	public static Class26 aClass26_1507;
	...
	static {
		aClass26_1501 = aClass26_1503;
		anInt1502 = 0;
		aBoolean1495 = false;
		aClass26_1507 = aClass26_1503;
		aClass26_1499 = RS2Font.getRs2PreparedString("Sprites geladen)3", false);
	}
	...
	public static void method1165(byte arg0) {
		try {
			...
			anInt1506++;
			Class26.anIntArray1798 = new int[104];
	...
	public static void method1166(int arg0, int arg1,
		...
		if ((0x80 & arg3) != 0) {
			arg2.aClass26_3271 = Class4_Sub20_Sub5.aClass4_Sub11_Sub1_2883
					.method212(arg1 + -17848);
			if (arg2.aClass26_3271.method834(21340, 0) == 126) {
				arg2.aClass26_3271 = arg2.aClass26_3271.method805(1, arg1
						^ ~0x466a);
				Class43.method955(arg2.aClass26_3271, arg2.aClass26_3593,
						(byte) 122, 2);
		...
		if ((0x1 & arg3) != 0) {
			...
			if (arg2.aClass26_3593 != null && arg2.aClass35_3609 != null) {
				long l = arg2.aClass26_3593.method806((byte) -113);
				boolean bool = false;
				if (i_2_ <= 1) {
					for (int i_5_ = 0; ((i_5_ ^ 0xffffffff) > (Class26.anInt1827 ^ 0xffffffff)); i_5_++) {
				...
				if (!bool && Class81.anInt1695 == 0) {
					...
					arg2.aClass26_3271 = class26.method815(124);
					arg2.anInt3253 = 150;
						...
						if (i_2_ == 1)
							Class43.method955(
									...
									(Class4_Sub24.method639((new Class26[] {
											...
											arg2.aClass26_3593 }), arg1
											^ ~0x4544)), (byte) 126, 1);
						else
							Class43.method955(class26, arg2.aClass26_3593,
									(byte) 122, 2);
					} else
						Class43.method955(
								class26,
