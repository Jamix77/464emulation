...
public class Class78 {
	...
	public static Class26 aClass26_1606;
	public static Class26 aClass26_1608;
	...
	static {
		anInt1598 = 0;
		anInt1599 = 0;
		aClass26_1603 = RS2Font.getRs2PreparedString("gelb:", false);
		aClass26_1606 = RS2Font.getRs2PreparedString("p12_full", false);
		aClass26_1608 = RS2Font.getRs2PreparedString(
				"Geben Sie Ihren Benutzernamen", false);
		anIntArray1607 = new int[5];
		aClass26_1605 = RS2Font.getRs2PreparedString("nav", false);
	}
							...
							try {
								...
								if (i_11_ != 3) {
									...
									if (object == null)
										...
										arg2.method259((Class26) object, 18601);
									} else
