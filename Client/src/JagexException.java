...
public class JagexException extends RuntimeException {
	...
	public static Class26 aClass26_1733;
	public static Class26 aClass26_1734 = RS2Font.getRs2PreparedString(
			")4lang)4de", false);
	...
	static {
		aClass26_1733 = RS2Font.getRs2PreparedString("(Z", false);
	}
	...
	public static void method1219(Class19 arg0, Class19 arg1, byte arg2,
		...
		try {
			...
			if (!RSInterface.aBoolean2203) {
				...
				byte[] is = arg1.method753(false, Class26.aClass26_1824,
				...
				if (Class34.aBoolean1765)
					...
					Class31.method879(Class9.aClass26_269, 2,
