...
public class Class19_Sub1 extends Class19 {
	...
	public static Class26 aClass26_2514;
	public static Class26 aClass26_2515 = RS2Font.getRs2PreparedString(
			"Bitte geben Sie Ihr Passwort ein)3", false);
	public static Class26 aClass26_2518;
	public static Class26 aClass26_2528;
	public static Class26 aClass26_2529 = RS2Font.getRs2PreparedString(
			"Loaded wordpack", false);
	...
	static {
		aClass26_2518 = RS2Font.getRs2PreparedString(":chalreq:", false);
		anInt2511 = 5063219;
		aClass26_2528 = RS2Font.getRs2PreparedString("mapscene", false);
		aClass26_2514 = aClass26_2529;
		anInt2536 = 0;
		aBoolean2538 = false;
	}
	...
	public static Class26 method765(int arg0, int arg1, byte arg2) {
		try {
			anInt2534++;
			int i = arg0 - arg1;
			if ((i ^ 0xffffffff) > 8)
				return Class4_Sub20_Sub7_Sub6.aClass26_3430;
			if (arg2 != -45)
				aClass26_2518 = null;
			if ((i ^ 0xffffffff) > 5)
				return Class4_Sub1.aClass26_1856;
			if ((i ^ 0xffffffff) > 2)
				return Class45.aClass26_925;
			if ((i ^ 0xffffffff) > -1)
				return Class50.aClass26_1024;
			if ((i ^ 0xffffffff) < -10)
				return Class50.aClass26_1016;
			if ((i ^ 0xffffffff) < -7)
				return Class9.aClass26_278;
			if ((i ^ 0xffffffff) < -4)
				return Class4_Sub20_Sub3.aClass26_2803;
			if ((i ^ 0xffffffff) < -1)
				return Class4_Sub20_Sub13.aClass26_3108;
			return Class80.aClass26_1641;
		} catch (RuntimeException runtimeexception) {
