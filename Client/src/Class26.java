...
public class Class26 implements Interface3 {
	/* synthetic */public static Class<?> aClass1830;
	public static Class26 aClass26_1775;
	public static Class26 aClass26_1800;
	public static Class26 aClass26_1801 = RS2Font.getRs2PreparedString("(U1",
			false);
	public static Class26 aClass26_1812;
	public static Class26 aClass26_1814;
	public static Class26 aClass26_1815;
	public static Class26 aClass26_1822;
	public static Class26 aClass26_1824;
	...
	static {
		aClass26_1800 = RS2Font.getRs2PreparedString(
				"No reply from loginserver)3", false);
		aClass26_1812 = RS2Font.getRs2PreparedString("welle:", false);
		aClass26_1814 = RS2Font.getRs2PreparedString(
				"Starting game engine)3)3)3", false);
		aClass26_1822 = aClass26_1814;
		aClass26_1775 = aClass26_1800;
		aClass26_1824 = RS2Font.getRs2PreparedString("title)3jpg", false);
		aClass26_1815 = RS2Font.getRs2PreparedString(" )2> <col=ffffff>", false);
		anInt1827 = 0;
	}
	...
	public static boolean method830(int arg0, Class26 arg1) {
		try {
			anInt1790++;
			if (arg1 == null)
				return false;
			for (int i = 0; RSApplet.anInt23 > i; i++) {
				if (arg1.method818(Class4_Sub20_Sub5.aClass26Array2893[i],
						(byte) -105))
					return true;
			}
			if (arg1.method818(
					(Class4_Sub15.aClass4_Sub20_Sub7_Sub1_Sub1_2302.aClass26_3593),
					(byte) -105))
				return true;
			if (arg0 != 60)
				method823(-127, null);
	...
	/* synthetic */public static Class<?> method842(String arg0) {
		try {
	...
	public boolean equals(Object arg0) {
		try {
			...
			if (arg0 instanceof Class26)
				return method802(1, (Class26) arg0);
	...
	public Class26 method801(boolean arg0) {
		try {
			anInt1777++;
			int i = 2;
			...
			if (arg0 != false)
				method819((byte) 39);
			class26.anInt1805 = anInt1805;
			class26.aByteArray1803 = new byte[anInt1805];
			for (int i_0_ = 0; (anInt1805 ^ 0xffffffff) < (i_0_ ^ 0xffffffff); i_0_++) {
				...
				class26.aByteArray1803[i_0_] = i_1_;
			}
			return class26;
		} catch (RuntimeException runtimeexception) {
	...
	public boolean method802(int arg0, Class26 arg1) {
		try {
			anInt1778++;
			if (arg1 == null)
				return false;
	...
	public int method803(Class26 arg0, byte arg1) {
		try {
			anInt1792++;
	...
	public Class26 method805(int arg0, int arg1) {
		try {
			anInt1776++;
	...
	public int method807(Class26 arg0, int arg1, int arg2) {
		try {
			int[] is = new int[arg2];
	...
	public boolean method808(Class26 arg0, byte arg1) {
		try {
			anInt1784++;
	...
	public Class26 method809(int arg0) {
		try {
			anInt1807++;
			Class26 class26 = new Class26();
			class26.anInt1805 = anInt1805;
			...
			for (int i_13_ = 0; (anInt1805 ^ 0xffffffff) < (i_13_ ^ 0xffffffff); i_13_++)
				class26.aByteArray1803[i_13_] = (byte) 42;
			return class26;
		} catch (RuntimeException runtimeexception) {
	...
	public int method813(int arg0, Class26 arg1) {
		try {
			anInt1782++;
			int i;
	...
	public Class26 method815(int arg0) {
		try {
			int i = 0;
			anInt1802++;
			if (arg0 <= 120)
			...
			if ((i ^ 0xffffffff) == -1
				...
				return this;
			Class26 class26 = new Class26();
			class26.anInt1805 = -i + i_16_;
			class26.aByteArray1803 = new byte[class26.anInt1805];
			for (int i_17_ = 0; (i_17_ ^ 0xffffffff) > (class26.anInt1805 ^ 0xffffffff); i_17_++)
				class26.aByteArray1803[i_17_] = aByteArray1803[i + i_17_];
			return class26;
		} catch (RuntimeException runtimeexception) {
	...
	public Class26 method816(int arg0) {
		try {
			Class26 class26 = new Class26();
			class26.anInt1805 = 0;
			class26.aByteArray1803 = new byte[12];
			anInt1791++;
			int i = 0;
			for (int i_18_ = 0; i_18_ < anInt1805; i_18_++) {
				if (aByteArray1803[i_18_] < 65 || aByteArray1803[i_18_] > 90) {
					if (((aByteArray1803[i_18_] ^ 0xffffffff) > -98 || aByteArray1803[i_18_] > 122)
						...
						if ((i ^ 0xffffffff) < -1)
							class26.aByteArray1803[i++] = (byte) 95;
					} else {
						class26.aByteArray1803[i++] = aByteArray1803[i_18_];
						class26.anInt1805 = i;
					}
				} else {
					class26.aByteArray1803[i++] = (byte) (32 + aByteArray1803[i_18_]);
					class26.anInt1805 = i;
				}
				if ((i ^ 0xffffffff) == -13)
					break;
	...
	public boolean method818(Class26 arg0, byte arg1) {
		try {
			anInt1826++;
			if (arg0 == null)
				return false;
	...
	public Class26 method824(int arg0, int arg1) {
		try {
			anInt1829++;
	...
	public boolean method826(Class26 arg0, byte arg1) {
		try {
			anInt1820++;
			if (anInt1805 < arg0.anInt1805)
				return false;
	...
	public Class26 method827(byte arg0) {
		try {
			anInt1818++;
			Class26 class26 = new Class26();
			class26.anInt1805 = anInt1805;
			...
			for (int i = 0; (i ^ 0xffffffff) > (anInt1805 ^ 0xffffffff); i++) {
				...
				if ((i_25_ ^ 0xffffffff) <= -66
					...
					i_25_ += 32;
				class26.aByteArray1803[i] = i_25_;
			}
			return class26;
		} catch (RuntimeException runtimeexception) {
	...
	public Class26 method828(boolean arg0) {
		try {
			anInt1793++;
			long l = method812(255);
			synchronized (aClass1830 != null ? aClass1830
					: (aClass1830 = method842("Class26"))) {
				if (Class4_Sub20_Sub7.aClass16_2950 != null) {
					for (Class4_Sub21 class4_sub21 = (Class4_Sub21) Class4_Sub20_Sub7.aClass16_2950
							...
							.method728(12133)) {
						if (method802(1, class4_sub21.aClass26_2364))
							return class4_sub21.aClass26_2364;
					}
				} else
					Class4_Sub20_Sub7.aClass16_2950 = new Class16(4096);
				Class4_Sub21 class4_sub21 = new Class4_Sub21();
				class4_sub21.aClass26_2364 = this;
				aBoolean1774 = false;
	...
	public Class26 method829(byte arg0, int arg1, int arg2) {
		try {
			anInt1797++;
			Class26 class26 = new Class26();
			class26.aByteArray1803 = new byte[arg2 - arg1];
			class26.anInt1805 = arg2 + -arg1;
			Class21.method777(aByteArray1803, arg1, class26.aByteArray1803, 0,
					class26.anInt1805);
			return class26;
		} catch (RuntimeException runtimeexception) {
	...
	public Class26 method831(int arg0) {
		try {
			anInt1787++;
			if (!aBoolean1774)
				throw new IllegalArgumentException();
	...
	public Class26 method832(Class26 arg0, byte arg1) {
		try {
			anInt1809++;
			if (!aBoolean1774)
				throw new IllegalArgumentException();
	...
	public int method833(Class26 arg0, int arg1) {
		try {
			anInt1811++;
			int i;
			if (arg0.anInt1805 >= anInt1805)
	...
	public Class26 method838(int arg0, int arg1) {
		try {
			anInt1823++;
			if ((arg1 ^ 0xffffffff) >= -1 || (arg1 ^ 0xffffffff) < -256)
				throw new IllegalArgumentException("invalid char");
			Class26 class26 = new Class26();
			class26.aByteArray1803 = new byte[1 + anInt1805];
			class26.anInt1805 = 1 + anInt1805;
			Class21.method777(aByteArray1803, 0, class26.aByteArray1803, 0,
					anInt1805);
			if (arg0 != 15871)
				method830(28, null);
			class26.aByteArray1803[anInt1805] = (byte) arg1;
			return class26;
		} catch (RuntimeException runtimeexception) {
	...
	public Class26 method839(int arg0) {
		try {
			anInt1799++;
			if (arg0 <= 77)
				method819((byte) -12);
			...
			for (int i = 0; (i ^ 0xffffffff) > (anInt1805 ^ 0xffffffff); i++) {
				...
				if ((i_31_ ^ 0xffffffff) != -96) {
					if ((i_31_ ^ 0xffffffff) <= -98
						...
						bool = false;
						class26.aByteArray1803[i] = (byte) (i_31_ - 32);
					} else {
						bool = false;
						class26.aByteArray1803[i] = i_31_;
					}
				} else {
					class26.aByteArray1803[i] = (byte) 32;
					bool = true;
				}
			}
			return class26;
