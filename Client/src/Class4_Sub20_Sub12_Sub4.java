...
public abstract class Class4_Sub20_Sub12_Sub4 extends Class4_Sub20_Sub12 {
	public static Class26 aClass26_3547 = RS2Font.getRs2PreparedString(")4col",
			false);
	public static Class26 aClass26_3548;
	public static Class26 aClass26_3550;
	public static Class26 aClass26_3551 = RS2Font.getRs2PreparedString(")4shad",
			false);
	public static Class26 aClass26_3552 = RS2Font.getRs2PreparedString("br",
			false);
	public static Class26 aClass26_3554;
	public static Class26 aClass26_3557;
	public static Class26 aClass26_3560;
	public static Class26 aClass26_3563;
	public static Class26 aClass26_3564;
	public static Class26 aClass26_3565;
	public static Class26 aClass26_3568;
	public static Class26 aClass26_3569;
	public static Class26 aClass26_3574;
	public static Class26 aClass26_3576;
	public static Class26[] aClass26Array3578;
	...
	static {
		...
		anInt3544 = -1;
		anInt3545 = -1;
		aClass26_3548 = RS2Font.getRs2PreparedString("str", false);
		aClass26_3554 = RS2Font.getRs2PreparedString("shad", false);
		anInt3562 = 256;
		aClass26_3564 = RS2Font.getRs2PreparedString(")4u", false);
		aClass26_3550 = RS2Font.getRs2PreparedString(")4str", false);
		aClass26_3557 = RS2Font.getRs2PreparedString("u=", false);
		aClass26_3569 = RS2Font.getRs2PreparedString("str=", false);
		aClass26_3563 = RS2Font.getRs2PreparedString("shad=", false);
		aClass26_3565 = RS2Font.getRs2PreparedString("col=", false);
		aClass26_3568 = RS2Font.getRs2PreparedString("gt", false);
		anInt3555 = 0;
		aClass26_3560 = RS2Font.getRs2PreparedString("lt", false);
		anInt3573 = 0;
		anInt3561 = -1;
		aClass26_3574 = RS2Font.getRs2PreparedString("img=", false);
		anInt3577 = 0;
		aClass26_3576 = RS2Font.getRs2PreparedString("u", false);
		anInt3575 = -1;
		aRandom3570 = new Random();
		aClass26Array3578 = new Class26[100];
	}
	...
	public static Class26 method574(Class26 arg0) {
		...
		class26.anInt1805 = i + i_87_;
		class26.aByteArray1803 = new byte[class26.anInt1805];
		int i_90_ = 0;
		for (int i_91_ = 0; i_91_ < i; i_91_++) {
			byte i_92_ = arg0.aByteArray1803[i_91_];
			if (i_92_ == 60) {
				class26.aByteArray1803[i_90_++] = (byte) 60;
				class26.aByteArray1803[i_90_++] = (byte) 108;
				class26.aByteArray1803[i_90_++] = (byte) 116;
				class26.aByteArray1803[i_90_++] = (byte) 62;
			} else if (i_92_ == 62) {
				class26.aByteArray1803[i_90_++] = (byte) 60;
				class26.aByteArray1803[i_90_++] = (byte) 103;
				class26.aByteArray1803[i_90_++] = (byte) 116;
				class26.aByteArray1803[i_90_++] = (byte) 62;
			} else
				class26.aByteArray1803[i_90_++] = i_92_;
		}
		return class26;
	}
	...
	public void method556(Class26 arg0, int arg1, int arg2) {
		arg2 -= anInt3546;
		int i = -1;
		int i_6_ = -1;
		for (int i_7_ = 0; i_7_ < arg0.anInt1805; i_7_++) {
			...
			if (i_8_ == 60)
				...
				if (i_8_ == 62 && i != -1) {
					Class26 class26 = arg0.method829((byte) -108, i + 1, i_7_);
					i = -1;
					if (class26.method802(1, aClass26_3560))
						i_8_ = 60;
					else if (class26.method802(1, aClass26_3568))
						i_8_ = 62;
					else {
						if (class26.method808(aClass26_3574, (byte) -95)) {
							try {
								int i_9_ = class26.method805(4, 89).method804(
										(byte) -83);
	...
	public void method557(Class26 arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg0 != null) {
			method576(arg3, arg4);
	...
	public int method560(Class26 arg0) {
		if (arg0 == null)
			return 0;
		int i = -1;
		int i_29_ = -1;
		...
		for (int i_31_ = 0; i_31_ < arg0.anInt1805; i_31_++) {
			...
			if (i_32_ == 60)
				...
				if (i_32_ == 62 && i != -1) {
					Class26 class26 = arg0.method829((byte) 13, i + 1, i_31_);
					i = -1;
					if (class26.method802(1, aClass26_3560))
						i_32_ = 60;
					else if (class26.method802(1, aClass26_3568))
						...
						if (class26.method808(aClass26_3574, (byte) -95)) {
							try {
								int i_33_ = class26.method805(4, 107)
										.method804((byte) -126);
	...
	public int method561(Class26 arg0, int[] arg1, Class26[] arg2) {
		if (arg0 == null)
			return 0;
		int i = 0;
		int i_34_ = 0;
		Class26 class26 = Class4_Sub10.method205((byte) -126, 100);
		int i_35_ = -1;
		int i_36_ = 0;
		int i_37_ = 0;
		int i_38_ = -1;
		...
		for (int i_42_ = 0; i_42_ < i_41_; i_42_++) {
			...
			if (i_43_ == 60)
				...
				if (i_43_ == 62 && i_38_ != -1) {
					Class26 class26_44_ = arg0.method829((byte) -108,
							i_38_ + 1, i_42_);
					i_38_ = -1;
					class26.method824(60, 0);
					class26.method832(class26_44_, (byte) -28);
					class26.method824(62, 0);
					if (class26_44_.method802(1, aClass26_3552)) {
						arg2[i_40_++] = class26.method829((byte) 76, i_34_,
								class26.method825(-111));
						i_34_ = class26.method825(-114);
						i = 0;
						i_35_ = -1;
						i_39_ = -1;
					} else if (class26_44_.method802(1, aClass26_3560)) {
						i += method579(60);
						if (aByteArray3558 != null && i_39_ != -1)
							i += aByteArray3558[(i_39_ << 8) + 60];
						i_39_ = 60;
					} else if (class26_44_.method802(1, aClass26_3568)) {
						i += method579(62);
						if (aByteArray3558 != null && i_39_ != -1)
							i += aByteArray3558[(i_39_ << 8) + 62];
						i_39_ = 62;
					} else if (class26_44_.method808(aClass26_3574, (byte) -95)) {
						try {
							int i_45_ = class26_44_.method805(4, -23)
									.method804((byte) -88);
				...
				if (i_38_ == -1) {
					...
					if (arg1 != null
						...
						arg2[i_40_++] = class26.method829((byte) -120, i_34_,
								i_35_ - i_37_);
						i_34_ = i_35_;
						i_35_ = -1;
						i -= i_36_;
		...
		if (class26.method825(-99) > i_34_)
			arg2[i_40_++] = class26.method829((byte) 63, i_34_,
					class26.method825(-107));
		return i_40_;
	}
	...
	public void method563(Class26 arg0, int arg1, int arg2, int arg3, int arg4,
			int arg5) {
		if (arg0 != null) {
			method576(arg3, arg4);
	...
	public int method566(Class26 arg0, int arg1, int arg2, int arg3, int arg4,
		...
		if (arg4 < anInt3542 + anInt3567 + arg9 && arg4 < arg9 + arg9)
			is = null;
		int i = method561(arg0, is, aClass26Array3578);
		if (arg8 == 3 && i == 1)
			arg8 = 1;
		int i_66_;
		if (arg8 == 0)
		...
		for (int i_68_ = 0; i_68_ < i; i_68_++) {
			if (arg7 == 0)
				method556(aClass26Array3578[i_68_], arg1, i_66_);
			else if (arg7 == 1)
				method556(
						aClass26Array3578[i_68_],
						(arg1 + (arg3 - method560(aClass26Array3578[i_68_])) / 2),
						i_66_);
			else if (arg7 == 2)
				method556(aClass26Array3578[i_68_], arg1 + arg3
						- method560(aClass26Array3578[i_68_]), i_66_);
			else if (i_68_ == i - 1)
				method556(aClass26Array3578[i_68_], arg1, i_66_);
			else {
				method573(aClass26Array3578[i_68_], arg3);
				method556(aClass26Array3578[i_68_], arg1, i_66_);
				anInt3573 = 0;
			}
			i_66_ += arg9;
	...
	public void method567(Class26 arg0, int arg1, int arg2, int arg3, int arg4,
			int arg5, int arg6) {
		if (arg0 != null) {
			method576(arg3, arg4);
	...
	public int method568(Class26 arg0, int arg1) {
		int i = method561(arg0, new int[] { arg1 }, aClass26Array3578);
		int i_69_ = 0;
		for (int i_70_ = 0; i_70_ < i; i_70_++) {
			int i_71_ = method560(aClass26Array3578[i_70_]);
			if (i_71_ > i_69_)
				i_69_ = i_71_;
		}
		return i_69_;
	...
	public void method569(Class26 arg0, int arg1, int arg2, int arg3, int arg4,
			int arg5) {
		if (arg0 != null) {
			method576(arg3, arg4);
			int[] is = new int[arg0.anInt1805];
	...
	public int method570(Class26 arg0, int arg1) {
		return method561(arg0, new int[] { arg1 }, aClass26Array3578);
	}

	public void method571(Class26 arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg0 != null) {
			method576(arg3, arg4);
	...
	public void method572(Class26 arg0, int arg1, int arg2, int[] arg3,
			int[] arg4) {
		arg2 -= anInt3546;
		int i = -1;
		int i_73_ = -1;
		...
		for (int i_75_ = 0; i_75_ < arg0.anInt1805; i_75_++) {
			...
			if (i_76_ == 60)
				...
				if (i_76_ == 62 && i != -1) {
					Class26 class26 = arg0.method829((byte) 110, i + 1, i_75_);
					i = -1;
					if (class26.method802(1, aClass26_3560))
						i_76_ = 60;
					else if (class26.method802(1, aClass26_3568))
						...
						if (class26.method808(aClass26_3574, (byte) -95)) {
							try {
								...
								if (arg4 != null)
									...
									i_78_ = 0;
								i_74_++;
								int i_79_ = class26.method805(4, 77).method804(
										(byte) -103);
	...
	public void method573(Class26 arg0, int arg1) {
		int i = 0;
		boolean bool = false;
	...
	public void method575(Class26 arg0, int arg1, int arg2, int arg3, int arg4,
			int arg5) {
		if (arg0 != null) {
			method576(arg3, arg4);
	...
	public void method577(Class26 arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg0 != null) {
			method576(arg3, arg4);
	...
	public void method580(Class26 arg0) {
		do {
			try {
				if (arg0.method808(aClass26_3565, (byte) -95))
					anInt3577 = arg0.method805(4, -23).method835(-9613, 16);
				else if (arg0.method802(1, aClass26_3547))
					anInt3577 = anInt3555;
				else if (arg0.method808(aClass26_3569, (byte) -95))
					anInt3544 = arg0.method805(4, -88).method835(-9613, 16);
				else if (arg0.method802(1, aClass26_3548))
					anInt3544 = 8388608;
				else if (arg0.method802(1, aClass26_3550))
					anInt3544 = -1;
				else if (arg0.method808(aClass26_3557, (byte) -95))
					anInt3561 = arg0.method805(2, -39).method835(-9613, 16);
				else if (arg0.method802(1, aClass26_3576))
					anInt3561 = 0;
				else if (arg0.method802(1, aClass26_3564))
					anInt3561 = -1;
				else if (arg0.method808(aClass26_3563, (byte) -95))
					anInt3575 = arg0.method805(5, -61).method835(-9613, 16);
				else if (arg0.method802(1, aClass26_3554))
					anInt3575 = 0;
				else if (arg0.method802(1, aClass26_3551))
					anInt3575 = anInt3545;
				else {
					if (!arg0.method802(1, aClass26_3552))
						break;
