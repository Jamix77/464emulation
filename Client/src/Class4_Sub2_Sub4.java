...
public class Class4_Sub2_Sub4 extends Class4_Sub2 {
	...
	public static Class26 aClass26_2650 = (RS2Font.getRs2PreparedString(
			"Startseite auf (WSpielkonto wiederherstellen(W)3", false));
	public static Class26 aClass26_2653 = RS2Font.getRs2PreparedString(
			"bevor Sie den Vorgang wiederholen)3", false);
	...
	public static Class26 method167(int arg0, RSInterface arg1) {
		try {
			if (arg0 >= -56)
				method170(2, null);
			anInt2649++;
			if (Class68.method1092(14423, Class54.method1011(arg1, -22389)) == 0)
				return null;
			if (arg1.aClass26_2174 == null
					|| arg1.aClass26_2174.method815(127).method825(-108) == 0) {
				if (Class19_Sub1.aBoolean2538)
					return RS2Font.aClass26_2767;
				return null;
			}
			return arg1.aClass26_2174;
