...
public class Class48 {
	public static Class26 aClass26_977 = RS2Font.getRs2PreparedString(
			"Please contact customer support)3", false);
	public static Class26 aClass26_985;
	public static Class26 aClass26_986;
	public static Class26 aClass26_988;
	...
	static {
		...
		anInt984 = 0;
		aClass26_986 = RS2Font.getRs2PreparedString("<img=0>", false);
		aClass26_985 = aClass26_977;
		aClass26_988 = RS2Font.getRs2PreparedString(
				"oberen Rand der Webseite ausw-=hlen)3", false);
		anInt989 = 0;
	}
	...
	public static void method984(long arg0, byte arg1) {
		try {
			...
			if ((arg0 ^ 0xffffffffffffffffL) != -1L) {
				if ((Class26.anInt1827 ^ 0xffffffff) <= -101)
					Class43.method955(RSFont.aClass26_138,
							Class4_Sub3.aClass26_1895, (byte) 123, 0);
				else {
					Class26 class26 = Class68.method1094(-5, arg0).method839(
							118);
					for (int i = 0; (i ^ 0xffffffff) > (Class26.anInt1827 ^ 0xffffffff); i++) {
							...
							Class43.method955(
									Class4_Sub24
											.method639(
													(new Class26[] {
															class26,
															(Class4_Sub20_Sub10.aClass26_3067) }),
													-842),
						...
						if (arg0 == Class64.aLongArray1279[i]) {
							Class43.method955(
									Class4_Sub24
											.method639(
													(new Class26[] {
															(Class53.aClass26_1084),
															class26,
															(Class4_Sub20_Sub9.aClass26_3049) }),
													-842),
									Class4_Sub3.aClass26_1895, (byte) 120, 0);
							return;
						}
					}
					if (class26
						...
						Class43.method955(Class4_Sub20_Sub6.aClass26_2897,
								Class4_Sub3.aClass26_1895, (byte) 115, 0);
					else {
