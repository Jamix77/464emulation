...
public class Class57 {
	...
	public static Class26 aClass26_1126;
	public static Class26 aClass26_1128;
	public static Class26 aClass26_1139;
	public static Class26 aClass26_1152;
	public static Class26 aClass26_1154;
	...
	static {
		...
		anInt1130 = 0;
		aClass26_1126 = RS2Font.getRs2PreparedString("hel", false);
		aClass26_1139 = RS2Font.getRs2PreparedString("Lade Schrifts-=tze )2 ",
				false);
		aBoolean1132 = false;
		aClass26_1128 = RS2Font.getRs2PreparedString("Use", false);
		anInt1141 = 0;
		anInt1147 = (int) (Math.random() * 17.0) + -8;
		aClass4_Sub20_Sub7_Sub1_Sub2Array1151 = new Class4_Sub20_Sub7_Sub1_Sub2[32768];
		aClass26_1152 = RS2Font.getRs2PreparedString("Okay", false);
		aClass26_1154 = aClass26_1128;
			...
			for (int i = -1; Class4_Sub20_Sub7_Sub6.anInt3431 > i; i++) {
				...
				if (class4_sub20_sub7_sub1_sub1 != null
					...
					if (class4_sub20_sub7_sub1_sub1.anInt3253 == 0)
						class4_sub20_sub7_sub1_sub1.aClass26_3271 = null;
				}
			}
			for (int i = 0; (RSApplet.anInt12 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
				...
				if (class4_sub20_sub7_sub1_sub2 != null
					...
					if (class4_sub20_sub7_sub1_sub2.anInt3253 == 0)
						class4_sub20_sub7_sub1_sub2.aClass26_3271 = null;
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public static Class4_Sub20_Sub12_Sub4_Sub1 method1026(Class26 arg0,
			Class19 arg1, int arg2, Class26 arg3, Class19 arg4) {
		try {
			anInt1146++;
