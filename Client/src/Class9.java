...
public class Class9 {
	...
	public static Class26 aClass26_269 = RS2Font.getRs2PreparedString(
			"scape main", false);
	public static Class26 aClass26_278;
	public static RSInterface aClass4_Sub13_285;
	public static Class66 aClass66_277;
	public static volatile long aLong281;
	public static volatile long aLong282;
	...
	static {
		...
		aLong282 = 0L;
		aClass26_278 = RS2Font.getRs2PreparedString("<col=40ff00>", false);
		aLong281 = 0L;
		aByte280 = (byte) 0;
						...
						if ((rsInterface.anInt2258 ^ 0xffffffff) == -1) {
							...
							if (class4_sub16 != null) {
								if (class4_sub16.anInt2306 == 0
									...
									Class4_Sub20_Sub8.aClass26Array2957[0] = Class82.aClass26_1713;
									Class18.aClass26Array462[0] = Class4_Sub3.aClass26_1895;
								}
							...
							if ((rsInterface.anInt2258 ^ 0xffffffff) != -2) {
								if ((rsInterface.anInt2258 ^ 0xffffffff) == -3) {
									...
									if (class4_sub20_sub12_sub4_sub1 == null) {
										...
										Class26 class26 = rsInterface.aClass26_2150;
										int i_33_;
										if (Class35.method902(rsInterface, 2)) {
											...
											if ((rsInterface.aClass26_2149
													.method825(-112) ^ 0xffffffff) < -1)
												class26 = (rsInterface.aClass26_2149);
										} else {
										...
										if (rsInterface.aBoolean2178
											...
											Class4_Sub20_Sub8 class4_sub20_sub8 = (Class4_Sub23
													.method633(
															...
															(byte) -105));
											class26 = (class4_sub20_sub8.aClass26_2991);
											if (class26 == null)
												class26 = (Class4_Sub24.aClass26_2448);
											if (((class4_sub20_sub8.anInt3012 == 1) || (rsInterface.anInt2143 != 1))
													&& (rsInterface.anInt2143 != -1))
												class26 = (Class4_Sub24
														.method639(
																(new Class26[] {
																		(Class62.aClass26_1230),
																		class26,
																		(Class18.aClass26_484),
																		(Class35.method912(
																				(byte) 97,
										...
										if (RSInterface.aClass4_Sub13_2141 == rsInterface) {
											class26 = Class71.aClass26_1470;
											i_33_ = rsInterface.anInt2195;
										}
										if (!rsInterface.aBoolean2178)
											class26 = (Class65.method1076(
													class26, rsInterface,
													false));
													...
													if ((class4_sub20_sub8.anInt3012) == 1
														...
														class26 = (Class4_Sub24
																.method639(
																		(new Class26[] {
																				(Class62.aClass26_1230),
																				(class4_sub20_sub8.aClass26_2991),
																				(Class18.aClass26_484),
																				(Class35.method912(
																						(byte) 83,
									...
									if (rsInterface.anInt2258 == 8
										...
										int i_51_ = 0;
										Class26 class26 = rsInterface.aClass26_2150;
										class26 = Class65.method1076(class26,
												rsInterface, false);
										while (class26.method825(-120) > 0) {
											int i_52_ = (class26.method803(
													Class11.aClass26_316,
													(byte) 122));
											Class26 class26_53_;
											if (i_52_ != -1) {
												class26_53_ = (class26
														.method829((byte) -112,
																0, i_52_));
												class26 = class26.method805(
														(i_52_ - -4), -47);
											} else {
												class26_53_ = class26;
												class26 = (Class4_Sub3.aClass26_1895);
											}
											int i_54_ = class4_sub20_sub12_sub4_sub1
													.method560(class26_53_);
											if (i_51_ < i_54_)
												i_51_ = i_54_;
										...
										int i_57_ = ((class4_sub20_sub12_sub4_sub1.anInt3546)
												+ i_56_ - -2);
										class26 = rsInterface.aClass26_2150;
										class26 = Class65.method1076(class26,
												rsInterface, false);
										while ((class26.method825(-110) ^ 0xffffffff) < -1) {
											int i_58_ = (class26.method803(
													Class11.aClass26_316,
													(byte) 119));
											Class26 class26_59_;
											if (i_58_ != -1) {
	...
	public static void method665(int arg0, int arg1) {
		try {
			...
			if ((arg1 ^ 0xffffffff) == 2)
				Class4_Sub20_Sub9.method477(Class14.aClass26_398, 16,
						Class4_Sub6.aClass26_1942, Class81.aClass26_1675);
			else if (arg1 == -2)
				Class4_Sub20_Sub9.method477(Class52.aClass26_1051, 74,
						Class81.aClass26_1679, Class81.aClass26_1655);
			else if ((arg1 ^ 0xffffffff) != 0) {
				if ((arg1 ^ 0xffffffff) == -4)
					Class4_Sub20_Sub9.method477(
							(Class4_Sub20_Sub16.aClass26_3165), 62,
							Class81.aClass26_1699, Class81.aClass26_1702);
				else if (arg1 == 4)
					Class4_Sub20_Sub9.method477(
							(Class4_Sub20_Sub7_Sub1_Sub2.aClass26_3623), 100,
							Class72.aClass26_1489, Class81.aClass26_1705);
				else if (arg1 != 5) {
					if (arg1 != 6) {
						if ((arg1 ^ 0xffffffff) != -8) {
							if ((arg1 ^ 0xffffffff) == -9)
								Class4_Sub20_Sub9.method477(
										Class43.aClass26_905, 110,
										Class4_Sub20_Sub14.aClass26_3147,
										Class81.aClass26_1706);
							else if (arg1 == 9)
								Class4_Sub20_Sub9.method477(
										Class67.aClass26_1360, 44,
										RSFont.aClass26_153,
										Class81.aClass26_1692);
							else if (arg1 == 10)
								Class4_Sub20_Sub9.method477(
										Class31.aClass26_692, 75,
										Class4_Sub20_Sub14.aClass26_3136,
										Class81.aClass26_1662);
							else if (arg1 != 11) {
								if (arg1 == 12)
									Class4_Sub20_Sub9.method477(
											Class37.aClass26_765, 31,
											Class52.aClass26_1055,
											Class81.aClass26_1687);
								else if (arg1 == 13)
									Class4_Sub20_Sub9.method477(
											Class14.aClass26_400, 19,
											Region.aClass26_120,
											Class81.aClass26_1669);
								else if ((arg1 ^ 0xffffffff) == -15)
									Class4_Sub20_Sub9.method477(
											Class61.aClass26_1210, 45,
											Class4_Sub10.aClass26_2049,
											Class81.aClass26_1684);
								else if (arg1 == 16)
									Class4_Sub20_Sub9.method477(
											Client.aClass26_1850, 94,
											Class53.aClass26_1068,
											Class81.aClass26_1668);
								else if ((arg1 ^ 0xffffffff) != -18) {
									if (arg1 == 18)
										Class4_Sub20_Sub9.method477(
												Class72.aClass26_1485, 87,
												Class4_Sub16.aClass26_2312,
												Class81.aClass26_1703);
									else if ((arg1 ^ 0xffffffff) != -20) {
										if ((arg1 ^ 0xffffffff) != -21) {
											if (arg1 == 22)
												Class4_Sub20_Sub9
														.method477(
																(Class4_Sub20_Sub8.aClass26_2996),
																7,
																Class12.aClass26_346,
																Class81.aClass26_1677);
											else if (arg1 != 23) {
												if (arg1 != 24) {
													if ((arg1 ^ 0xffffffff) != -26) {
														if ((arg1 ^ 0xffffffff) != -27) {
															if (arg1 == 27)
																Class4_Sub20_Sub9
																		.method477(
																				(Class12.aClass26_363),
																				41,
																				(Class81.aClass26_1686),
																				(Class81.aClass26_1664));
															else
																Class4_Sub20_Sub9
																		.method477(
																				(Class14.aClass26_397),
																				23,
																				(Class8.aClass26_250),
																				(Class81.aClass26_1694));
														} else
															Class4_Sub20_Sub9
																	.method477(
																			(Class43.aClass26_867),
																			46,
																			(Class41.aClass26_797),
																			(Class81.aClass26_1690));
													} else
														Class4_Sub20_Sub9
																.method477(
																		(Class14.aClass26_411),
																		110,
																		(Class4_Sub20_Sub11.aClass26_3089),
																		(Class81.aClass26_1663));
												} else
													Class4_Sub20_Sub9
															.method477(
																	Class48.aClass26_985,
																	18,
																	Class13.aClass26_370,
																	(Class81.aClass26_1696));
											} else
												Class4_Sub20_Sub9.method477(
														Class61.aClass26_1221,
														23,
														Class26.aClass26_1775,
														Class81.aClass26_1658);
										} else
											Class4_Sub20_Sub9.method477(
													Class14.aClass26_396, 73,
													Class30.aClass26_651,
													Class81.aClass26_1680);
									} else
										Class4_Sub20_Sub9
												.method477(
														Class35.aClass26_753,
														68,
														Class4_Sub20_Sub1.aClass26_2731,
														(Class4_Sub20_Sub7_Sub5.aClass26_3410));
								} else
									Class4_Sub20_Sub9.method477(
											RS2Font.aClass26_2786,
											15, Class35.aClass26_728,
											Class81.aClass26_1682);
							} else
								Class4_Sub20_Sub9.method477(
										Class66.aClass26_1319, 97,
										Class40.aClass26_788,
										Class81.aClass26_1657);
						} else
							Class4_Sub20_Sub9.method477(
									(Class4_Sub20_Sub7_Sub5.aClass26_3383), 88,
									Class7.aClass26_235, Class81.aClass26_1676);
					} else
						Class4_Sub20_Sub9.method477(
								(Class4_Sub20_Sub6.aClass26_2931), 93,
								SceneGraph.aClass26_2497,
								Class81.aClass26_1708);
				} else
					Class4_Sub20_Sub9.method477(Class18.aClass26_470, 51,
							Client.aClass26_1852, Class81.aClass26_1698);
			} else
				Class4_Sub20_Sub9.method477(Class14.aClass26_393, 127,
						Class2.aClass26_93, Class81.aClass26_1674);
