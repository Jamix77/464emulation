...
public class Class8 {
	...
	public static Class26 aClass26_240;
	public static Class26 aClass26_242 = RS2Font.getRs2PreparedString(
			"Benutzen", false);
	...
	static {
		aClass26_240 = RS2Font.getRs2PreparedString("<)4col>", false);
		aClass26_247 = RS2Font.getRs2PreparedString(
				"Unexpected server response", false);
		aClass26_243 = RS2Font.getRs2PreparedString(" weitere Optionen", false);
		aByteArrayArray254 = new byte[250][];
		aClass26_250 = aClass26_247;
		anInt244 = 0;
		aClass26_256 = RS2Font.getRs2PreparedString(
				"da dieser Computer gegen unsere ", false);
