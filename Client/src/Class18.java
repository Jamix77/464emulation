...
public class Class18 implements KeyListener, FocusListener {
	...
	public static Class26 aClass26_464 = (RS2Font.getRs2PreparedString(
			"Wir vermuten)1 dass Ihr Konto gestohlen wurde", false));
	public static Class26 aClass26_469;
	public static Class26 aClass26_470;
	public static Class26 aClass26_472;
	public static Class26 aClass26_474;
	public static Class26 aClass26_478 = RS2Font.getRs2PreparedString(
			":tradereq:", false);
	public static Class26 aClass26_484;
	public static Class26[] aClass26Array462 = new Class26[500];
	...
	static {
		aClass26_469 = RS2Font.getRs2PreparedString(
				"Try again in 60 secs)3)3)3", false);
		anInt477 = -1;
		aClass26_472 = RS2Font.getRs2PreparedString("k", false);
		anInt476 = 127;
		aClass26_474 = (RS2Font.getRs2PreparedString(
				"Benutzen Sie die (WPasswort -=ndern(W Option", false));
		anInt475 = 0;
		aClass26_470 = aClass26_469;
		aLongArray483 = new long[100];
		anIntArray473 = new int[100];
		aClass26_484 = RS2Font.getRs2PreparedString("<)4col> x", false);
