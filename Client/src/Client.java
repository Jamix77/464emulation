...
public class Client extends RSApplet {
	...
	public static Class26 aClass26_1838 = RS2Font.getRs2PreparedString(
			"auf einer freien Welt zu spielen)3", false);
	public static Class26 aClass26_1846;
	public static Class26 aClass26_1847;
	public static Class26 aClass26_1848 = RS2Font.getRs2PreparedString(
			"Please wait 5 minutes before trying again)3", false);
	public static Class26 aClass26_1850;
	...
	static {
		aClass26_1846 = RS2Font.getRs2PreparedString(
				"Your account is already logged in)3", false);
		aClass26_1850 = aClass26_1848;
		aClass26_1847 = RS2Font.getRs2PreparedString("Lade Texturen )2 ", false);
		aClass26_1852 = aClass26_1846;
	}
		...
		try {
			try {
				...
				if (arg0[5].equals("english"))
					...
					Class4_Sub3.aClass26_1903 = JagexException.aClass26_1734;
				} else
					Class4_Sub12.method279(1);
	...
	public static void method31(int arg0, int arg1, Class4_Sub20_Sub7_Sub1 arg2) {
		try {
			...
			Class26.method823(arg1 + -42, arg2);
		} catch (RuntimeException runtimeexception) {
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception,
					("client.Q(" + arg0 + ',' + arg1 + ','
							+ (arg2 != null ? "{...}" : "null") + ')'));
	...
	public void method13(byte arg0) {
		...
		if (Class73.aBoolean1495) {
			...
			Class4_Sub20_Sub8.method464((byte) 79,
					Class4_Sub20_Sub7_Sub5.runeCanvas);
			Class4_Sub20_Sub7.method380(true,
					Class4_Sub20_Sub7_Sub5.runeCanvas);
			if (Region.aClass42_130 != null)
		...
		if (Class54.anInt1109 == 0)
			Class6.method650(Class34.aClass26_1762, null, false,
					Region.anInt135);
			...
			if ((Class54.anInt1109 ^ 0xffffffff) == -11)
				...
				if ((Class4_Sub20.anInt2353 ^ 0xffffffff) == -2) {
					...
					Class19.method735(
							...
							(Class4_Sub24.method639(
									(new Class26[] { Class7.aClass26_228,
											Class4_Sub20_Sub11.aClass26_3081,
											Class74.method1168(-7, i_0_),
											Class31.aClass26_684 }), -842)),
							(byte) -126);
				...
				Class19.method735(
						...
						Class4_Sub24.method639((new Class26[] {
								Class66.aClass26_1320, Class11.aClass26_316,
								Class81.aClass26_1666 }), -842), (byte) -126);
		} else
	...
	public void method16(int arg0) {
		try {
			method30(true);
			Class26.method810((byte) -124);
			anInt1832++;
			RSApplet.method15(-95);
	...
	public void method17(int arg0) {
		...
		Class4_Sub20_Sub8.method464((byte) 79,
				Class4_Sub20_Sub7_Sub5.runeCanvas);
		Class4_Sub20_Sub7.method380(true, Class4_Sub20_Sub7_Sub5.runeCanvas);
		if (arg0 != 0)
			aClass26_1850 = null;
		...
		if (Region.aClass42_130 != null)
			Region.aClass42_130.method943(117,
					Class4_Sub20_Sub7_Sub5.runeCanvas);
		RSApplet.anInt21 = Signlink.anInt1539;
		try {
	...
	public void method25(int arg0) {
		try {
			...
			if (arg0 == -19134) {
				...
				AppletListener.method1149((byte) 72);
				if (Region.aClass42_130 != null) {
