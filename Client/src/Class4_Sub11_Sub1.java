...
public class Class4_Sub11_Sub1 extends StreamBuffer {
	...
	public static Class26 aClass26_2678;
	public static Class26 aClass26_2679;
	public static Class26 aClass26_2683;
	public static Class26 aClass26_2692;
	public static Class26 aClass26_2693;
	public static Class26 aClass26_2694;
	public static Class26[] aClass26Array2671;
	public static Class26[] aClass26Array2673 = new Class26[1000];
	...
	static {
		aClass26Array2671 = new Class26[1000];
		aClass26_2683 = RS2Font.getRs2PreparedString("shake:", false);
		aClass26_2669 = aClass26_2683;
		aClass26_2679 = (RS2Font.getRs2PreparedString(
				"Die Adresse dieses Computers wurde gesperrt)1", false));
		anInt2682 = 0;
		aClass26_2676 = aClass26_2683;
		aClass26_2678 = RS2Font.getRs2PreparedString(
				"-5berpr-Ufen Sie Ihr Mitteilungsfach)3", false);
		aClass26_2692 = RS2Font.getRs2PreparedString(
				"Gegenstand f-Ur Mitglieder", false);
		aCRC32_2688 = new CRC32();
		anIntArray2695 = new int[32768];
		aClass26_2693 = RS2Font.getRs2PreparedString(" <col=00ff80>", false);
		aClass26_2694 = RS2Font.getRs2PreparedString(
				"Fehler bei der Verbindung zum Server)3", false);
	}
		...
		try {
			...
			if ((arg0 ^ 0xffffffffffffffffL) != -1L) {
				if (((RSApplet.anInt23 ^ 0xffffffff) <= -101 && (RSFont.anInt162 ^ 0xffffffff) != -2)
					...
					Class43.method955(Class27.aClass26_624,
							Class4_Sub3.aClass26_1895, (byte) 109, 0);
				else {
					if (arg1 != -314)
						aClass26_2693 = null;
					Class26 class26 = Class68.method1094(arg1 + 309, arg0)
							.method839(80);
					for (int i = 0; RSApplet.anInt23 > i; i++) {
						if ((arg0 ^ 0xffffffffffffffffL) == (Class64.aLongArray1279[i] ^ 0xffffffffffffffffL)) {
							Class43.method955(Class4_Sub24.method639(
									(new Class26[] { class26,
											(Class25.aClass26_581) }), -842),
									Class4_Sub3.aClass26_1895, (byte) 113, 0);
							return;
						}
					}
					for (int i = 0; (Class26.anInt1827 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
						if (Class9.aLongArray284[i] == arg0) {
							Class43.method955(Class4_Sub24.method639(
									(new Class26[] { (Class53.aClass26_1078),
											class26,
											(Class4_Sub10.aClass26_2046) }),
									arg1 + -528), Class4_Sub3.aClass26_1895,
									(byte) 126, 0);
							return;
						}
					}
					if (class26
						...
						Class43.method955(Class68.aClass26_1383,
								Class4_Sub3.aClass26_1895, (byte) 112, 0);
					else {
	...
	public static int method270(StreamBuffer arg0, int arg1, Class26 arg2) {
		try {
			int i = arg0.pointion;
