...
public class Class35 {
	...
	public static Class26 aClass26_724;
	public static Class26 aClass26_728;
	public static Class26 aClass26_733;
	public static Class26 aClass26_735 = RS2Font.getRs2PreparedString("null",
			false);
	public static Class26 aClass26_741 = (RS2Font.getRs2PreparedString(
			"Zu viele Anmelde)2Versuche von Ihrer Adresse", false));
	public static Class26 aClass26_753;
	...
	static {
		aClass26_733 = RS2Font.getRs2PreparedString(
				"Sorry invited players only)3", false);
		aClass26_724 = (RS2Font.getRs2PreparedString(
				"You are standing in a members)2only area)3", false));
		aClass26_728 = aClass26_724;
		aClass26_753 = aClass26_733;
	}
	...
	public static Class26 method912(byte arg0, int arg1) {
		try {
			anInt745++;
			if (arg0 < 55)
				return null;
			Class26 class26 = Class74.method1168(-52, arg1);
			for (int i = -3 + class26.method825(-105); i > 0; i -= 3)
				class26 = Class4_Sub24.method639(
						(new Class26[] { class26.method829((byte) 121, 0, i),
								(Class4_Sub20_Sub7_Sub5.aClass26_3404),
								class26.method805(i, -123) }), -842);
			if ((class26.method825(-114) ^ 0xffffffff) < -10)
				return (Class4_Sub24.method639(
						(new Class26[] {
								...
								Class4_Sub7.aClass26_1957, class26,
								Class7.aClass26_232 }), -842));
			if ((class26.method825(-126) ^ 0xffffffff) < -7)
				return (Class4_Sub24.method639(
						(new Class26[] {
								Class41.aClass26_838,
								class26.method829((byte) 17, 0,
										class26.method825(-110) + -4),
								Class73.aClass26_1507,
								Class4_Sub7.aClass26_1957, class26,
								Class7.aClass26_232 }), -842));
			return Class4_Sub24
					.method639((new Class26[] { Class45.aClass26_922, class26,
							Class8.aClass26_240 }), -842);
		} catch (RuntimeException runtimeexception) {
