...
public class Class4_Sub15 extends RSFont {
	public static Class26 aClass26_2291;
	public static Class26 aClass26_2292 = RS2Font.getRs2PreparedString(
			"oder ung-Ultiges Passwort)3", false);
	public static Class26 aClass26_2294;
	...
	static {
		aClass26_2291 = RS2Font.getRs2PreparedString("Verbindung abgebrochen)3",
				false);
		anIntArray2295 = new int[5];
		aClass26_2294 = RS2Font.getRs2PreparedString("Fertigkeit)2", false);
		aClass4_Sub13_2301 = null;
	}

	public static Class26 method298(int arg0, boolean arg1) {
		try {
			anInt2300++;
			if (arg1 != true)
				aClass4_Sub20_Sub12_Sub4_Sub1_2289 = null;
			if ((Class18.aClass26Array462[arg0].method825(-100) ^ 0xffffffff) < -1)
				return Class4_Sub24.method639(
						(new Class26[] {
								(Class4_Sub20_Sub8.aClass26Array2957[arg0]),
								Class46.aClass26_942,
								(Class18.aClass26Array462[arg0]) }), -842);
			return Class4_Sub20_Sub8.aClass26Array2957[arg0];
