...
public class Class1 {
	...
	public static Class26 aClass26_72 = (RS2Font.getRs2PreparedString(
			"Sie befinden sich in einem Mitglieder)2Gebiet(Q", false));
	public static Class26 aClass26_79;
	...
	static {
		anInt70 = 128;
		aClass26_69 = RS2Font.getRs2PreparedString("Abbrechen", false);
		anIntArray78 = new int[50];
		aClass26_79 = RS2Font.getRs2PreparedString(
				"60 Sekunden noch einmal)3)3)3", false);
		anInt74 = 0;
	}
	...
	public static void method41(int arg0) {
		...
		if (RSApplet.anInt12 > i) {
			for (int i_0_ = i; (i_0_ ^ 0xffffffff) > (RSApplet.anInt12 ^ 0xffffffff); i_0_++)
				Class58.anIntArray1164[Class4_Sub20_Sub7_Sub5.anInt3386++] = ByteBuffer.anIntArray2695[i_0_];
		}
		if (RSApplet.anInt12 < i)
			throw new RuntimeException("gnpov1");
		RSApplet.anInt12 = 0;
		for (int i_1_ = 0; (i ^ 0xffffffff) < (i_1_ ^ 0xffffffff); i_1_++) {
			int i_2_ = ByteBuffer.anIntArray2695[i_1_];
			...
			int i_3_ = Class4_Sub20_Sub5.aClass4_Sub11_Sub1_2883.method266(
					-1432215741, 1);
			if (i_3_ == 0) {
				ByteBuffer.anIntArray2695[RSApplet.anInt12++] = i_2_;
