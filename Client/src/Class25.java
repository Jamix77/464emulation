...
public class Class25 {
	...
	public static Class26 aClass26_578;
	public static Class26 aClass26_581;
	public static Class26 aClass26_586;
	public static Class26 aClass26_590;
	public static Class26 aClass26_594;
	public static Class26 aClass26_595;
	public static Class26 aClass26_596;
	...
	static {
		aClass26_578 = RS2Font.getRs2PreparedString(
				" is already on your friend list", false);
		aClass26_590 = RS2Font.getRs2PreparedString("Select", false);
		aClass26_581 = aClass26_578;
		aClass26_586 = aClass26_590;
		aClass66_592 = new Class66(50);
		aClass26_594 = RS2Font.getRs2PreparedString("Bitte versuchen Sie)1",
				false);
		anIntArray593 = new int[50];
		aClass26_595 = RS2Font.getRs2PreparedString("Angreifen", false);
		aClass26_596 = (RS2Font.getRs2PreparedString(
				"Spieler)3 Bitte w-=hlen Sie eine andere Welt)3", false));
	}
	...
	public static void method800(int arg0) {
		try {
			...
			Class81.anInt1693 = 0;
			AppletListener.anInt1450 = 0;
			AppletListener.anInt1454 = 0;
			Class47.anInt959 = 0;
			Class34.anInt1755 = 0;
			...
			if (arg0 <= -45) {
				...
				Class13_Sub2.method692(0, (byte) 96);
				for (int i = 0; i < 100; i++)
					Class4_Sub2_Sub1.aClass26Array2574[i] = null;
				...
				for (int i = 0; (i ^ 0xffffffff) > -9; i++) {
					Class4_Sub22.aClass26Array2387[i] = null;
