...
public class Class64 {
	...
	public static Class26 aClass26_1257;
	public static Class26 aClass26_1258;
	public static Class26 aClass26_1260;
	public static Class26 aClass26_1266;
	public static Class26 aClass26_1268 = RS2Font.getRs2PreparedString(
			"<img=1>", false);
	public static Class26 aClass26_1276;
	public static Class26 aClass26_1281;
	public static Class26 aClass26_1283;
	...
	static {
		aClass26_1258 = RS2Font.getRs2PreparedString("(U3", false);
		aClass26_1257 = RS2Font.getRs2PreparedString("rot:", false);
		anInt1277 = -1;
		aClass26_1276 = RS2Font.getRs2PreparedString("yellow:", false);
		aClass26_1266 = aClass26_1276;
		aClass26_1260 = aClass26_1276;
		aLongArray1279 = new long[200];
		aClass16_1259 = new Class16(512);
		anInt1282 = 0;
		aClass26_1283 = RS2Font.getRs2PreparedString(
				"Please enter your password)3", false);
		aClass26_1281 = aClass26_1283;
	}
	...
	public static Class26 method1065(int arg0, int arg1, int arg2,
			Class26[] arg3) {
		try {
			if (arg0 <= 72)
				aClass26_1266 = null;
			...
			for (int i_15_ = 0; (arg1 ^ 0xffffffff) < (i_15_ ^ 0xffffffff); i_15_++) {
				if (arg3[arg2 - -i_15_] == null)
					arg3[i_15_ + arg2] = Class4_Sub14.aClass26_2288;
				i += arg3[arg2 + i_15_].anInt1805;
			}
			byte[] is = new byte[i];
			int i_16_ = 0;
			for (int i_17_ = 0; i_17_ < arg1; i_17_++) {
				Class26 class26 = arg3[i_17_ + arg2];
				Class21.method777(class26.aByteArray1803, 0, is, i_16_,
						class26.anInt1805);
				i_16_ += class26.anInt1805;
			}
