...
public class Class13_Sub2 extends Class13 implements ImageProducer,
		ImageObserver {
	public static Class26 aClass26_2469 = RS2Font.getRs2PreparedString("me",
			false);
	public static Class26 aClass26_2474;
	public static Class26 aClass26_2475;
	public static Class26 aClass26_2477;
	public static Class26 aClass26_2479;
	public static Class26 aClass26_2481;
	...
	public static volatile int anInt2478;
	public static int[] anIntArray2480;
	public static short[][] aShortArrayArray2476;
	static {
		aClass66_2468 = new Class66(64);
		anInt2478 = -1;
		aClass26_2481 = RS2Font.getRs2PreparedString("flash1:", false);
		aClass26_2477 = RS2Font.getRs2PreparedString(
				"Bitte laden Sie die Seite neu)3", false);
		aClass26_2479 = aClass26_2481;
		aClass26_2474 = aClass26_2481;
		aClass26_2475 = RS2Font.getRs2PreparedString("Update)2Liste geladen)3",
				false);
	}

	public static void method690(Component arg0, int arg1) {
		try {
			arg0.removeMouseListener(Class76.aClass70_1552);
			anInt2466++;
			arg0.removeMouseMotionListener(Class76.aClass70_1552);
			arg0.removeFocusListener(Class76.aClass70_1552);
			Class43.anInt866 = arg1;
	...
	public static void method692(int arg0, byte arg1) {
		try {
			if (arg1 > 48) {
				anInt2460++;
				Class4_Sub20_Sub1.anInt2703 = arg0;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("i.A("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
			...
			if ((RSFont.anInt148 ^ 0xffffffff) == -9) {
				...
				Class4_Sub20_Sub9
						.method477(
								RSFont.aClass26_163,
								106,
								Class4_Sub16.aClass26_2317,
								(Class4_Sub24.method639(
										(new Class26[] {
												Class74.method1168(
														-21,
														Class4_Sub2_Sub1.anInt2590 / 60),
												Class53.aClass26_1076 }), -842)));
