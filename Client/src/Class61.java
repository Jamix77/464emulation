...
public class Class61 {
	...
	public static Class26 aClass26_1198 = (RS2Font.getRs2PreparedString(
			"Sie haben gerade eine andere Welt verlassen)3", false));
	public static Class26 aClass26_1203;
	public static Class26 aClass26_1206;
	public static Class26 aClass26_1210;
	public static Class26 aClass26_1212 = RS2Font
			.getRs2PreparedString("", false);
	public static Class26 aClass26_1220;
	public static Class26 aClass26_1221;
	public static long aLong1211;
	...
	static {
		anInt1208 = -1;
		aClass26_1203 = RS2Font.getRs2PreparedString(
				"Please wait 1 minute and try again)3", false);
		aClass26_1210 = aClass26_1203;
		anInt1201 = 1;
		aLong1211 = 0L;
		aClass26_1206 = RS2Font.getRs2PreparedString("mapdots", false);
		aClass26_1220 = RS2Font.getRs2PreparedString("compass", false);
		aClass26_1221 = aClass26_1203;
	}
			...
			if (Class54.anInt1109 == 30) {
				...
				synchronized (Class31.aClass53_690.anObject1086) {
					if (!Class54.aBoolean1103)
						...
						int i = 0;
						Class66.byteBuffer.putOpcode(185, arg0
								^ ~0x3b);
						Class66.byteBuffer
								.method227((byte) -27, 0);
						int i_0_ = Class66.byteBuffer.pointion;
						for (int i_1_ = 0; Class31.aClass53_690.anInt1089 > i_1_; i_1_++) {
							if ((-i_0_ + Class66.byteBuffer.pointion) >= 240)
								break;
							i++;
							...
							if (ByteBuffer.anInt2682 == i_3_
									&& (i_2_ ^ 0xffffffff) == (Class2.anInt95 ^ 0xffffffff)) {
								if ((Class59.anInt1184 ^ 0xffffffff) > -2048)
									Class59.anInt1184++;
							} else {
								int i_5_ = i_3_ + -ByteBuffer.anInt2682;
								ByteBuffer.anInt2682 = i_3_;
				...
				if ((Class62.anInt1227 ^ 0xffffffff) != -1) {
					...
					if ((Class62.anInt1227 ^ 0xffffffff) == -3)
						i_10_ = 1;
					long l = (-Class4_Sub20_Sub10.aLong3063 + aLong1211) / 50L;
					Class4_Sub20_Sub10.aLong3063 = aLong1211;
					if ((l ^ 0xffffffffffffffffL) < -4096L)
						l = 4095L;
					Class66.byteBuffer.putOpcode(99, arg0 + -74);
					int i_11_ = (int) l;
				...
				if (RSFont.aBoolean152 && Class40.anInt781 <= 0) {
					...
					Class40.anInt781 = 20;
					Class66.byteBuffer.putOpcode(128, -23);
					Class66.byteBuffer.putLEShortA(Class1.anInt70,
							(byte) 53);
					Class66.byteBuffer.putShort(Class49.anInt999,
							2018779304);
				}
				if (!Region.aBoolean126 != true
					...
					Class59.aBoolean1188 = true;
					Class66.byteBuffer.putOpcode(7, -59);
					Class66.byteBuffer.method227((byte) -27, 1);
				}
				if (Region.aBoolean126 == false && Class59.aBoolean1188 == true) {
					Class4_Sub3.anInt1876++;
					Class59.aBoolean1188 = false;
					Class66.byteBuffer.putOpcode(7, -94);
					Class66.byteBuffer.method227((byte) -27, 0);
				}
				...
				if (Class54.anInt1109 == 30) {
					...
					if (AppletListener.anInt1448 > 750)
						...
						if (i > 4500 && (i_24_ ^ 0xffffffff) < -4501) {
							...
							Class13_Sub2.method692(4000, (byte) 55);
							Class66.byteBuffer
									.putOpcode(230, -101);
						}
						Class80.anInt1637++;
						...
						if ((Class4_Sub20_Sub6.anInt2903 ^ 0xffffffff) < -51) {
							Class66.byteBuffer.putOpcode(202, -96);
							ByteBuffer.anInt2686++;
						}
						do {
							try {
								if (Class4_Sub20_Sub17.aClass76_3189 == null
										|| ((Class66.byteBuffer.pointion) ^ 0xffffffff) >= -1)
									break;
	...
	public static void method1045(boolean arg0, int arg1, int arg2, int arg3,
		...
		if (Class34.aBoolean1770) {
			Class4_Sub20_Sub12.method488(arg1, arg3, arg2, arg4, 0);
			Class19.method735(false, Class7.aClass26_228, (byte) -126);
		}
	...
	public static Class26 method1046(int arg0, byte arg1, int arg2, byte[] arg3) {
		try {
			anInt1209++;
			Class26 class26 = new Class26();
			class26.aByteArray1803 = new byte[arg0];
			class26.anInt1805 = 0;
			for (int i = arg2; (i ^ 0xffffffff) > (arg0 + arg2 ^ 0xffffffff); i++) {
				if (arg3[i] != 0)
					class26.aByteArray1803[class26.anInt1805++] = arg3[i];
			}
			if (arg1 != 73)
	...
	public static void method1047(Class26 arg0, boolean arg1, int arg2,
			Class26 arg3, Class26 arg4) {
		try {
			if (arg1 != false)
				anIntArray1222 = null;
			anInt1215++;
			for (int i = 99; (i ^ 0xffffffff) < -1; i--) {
				...
				Class13.aClass26Array385[i] = Class13.aClass26Array385[-1 + i];
				Class4_Sub2_Sub1.aClass26Array2574[i] = Class4_Sub2_Sub1.aClass26Array2574[i - 1];
				Class4_Sub20_Sub9.aClass26Array3046[i] = Class4_Sub20_Sub9.aClass26Array3046[-1
						+ i];
			}
			Class18.anIntArray473[0] = arg2;
			Class13.aClass26Array385[0] = arg0;
			Class4_Sub2_Sub1.aClass26Array2574[0] = arg4;
			Class4_Sub20_Sub9.aClass26Array3046[0] = arg3;
