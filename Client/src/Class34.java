...
public class Class34 implements Interface2 {
	...
	public static Class26 aClass26_1753;
	public static Class26 aClass26_1759;
	public static Class26 aClass26_1762;
	public static Class26 aClass26_1764;
	public static Class26 aClass26_1766;
	public static Class26 aClass26_1767;
	public static Class26 aClass26_1768;
	public static Class26 aClass26_1769;
	public static Class26 aClass26_1771;
	...
	static {
		...
		aClass26_1753 = RS2Font.getRs2PreparedString(
				"Bitte versuchen Sie es erneut)3", false);
		aClass66_1758 = new Class66(100);
		aClass26_1759 = RS2Font.getRs2PreparedString(")3runescape)3com", false);
		anInt1761 = 0;
		aBoolean1765 = false;
		anIntArray1763 = new int[] { 768, 1024, 1280, 512, 1536, 256, 0, 1792 };
		aBoolean1770 = true;
		aClass26_1767 = RS2Font.getRs2PreparedString("", false);
		aClass26_1762 = aClass26_1767;
		aClass26_1771 = aClass26_1767;
		aClass26_1766 = aClass26_1767;
		aClass26_1769 = aClass26_1767;
		aClass26_1764 = aClass26_1767;
		aClass26_1768 = aClass26_1767;
	}
	...
	public static int method895(boolean arg0, Class26 arg1) {
		try {
			anInt1742++;
			if (Class19_Sub1.anInt2536 == 1)
				return 7;
			if (arg1.method808(RS2Font.aClass26_2764, (byte) -95))
				return 1;
			if (arg1.method808(Class4_Sub20_Sub4.aClass26_2855, (byte) -95))
				return 1;
			if (arg1.method808(Class78.aClass26_1605, (byte) -95))
				return 2;
			if (arg1.method808(Class10.aClass26_309, (byte) -95))
				return 2;
			if (arg1.method808(Class46.aClass26_930, (byte) -95))
				return 3;
			if (arg1.method808(Class4_Sub20_Sub7_Sub1_Sub2.aClass26_3620,
					(byte) -95))
				return 4;
			if (arg0 != false)
				return 44;
			if (arg1.method808(Class13_Sub2.aClass26_2469, (byte) -95))
				return 4;
			if (arg1.method808(Class4_Sub6.aClass26_1917, (byte) -95))
				return 5;
			if (arg1.method808(Class57.aClass26_1126, (byte) -95))
				return 6;
			return 0;
		} catch (RuntimeException runtimeexception) {
	...
	public static Class26 method896(boolean arg0, int arg1, int arg2) {
		try {
			anInt1740++;
			if (arg2 <= 70)
				aClass26_1764 = null;
