...
public class Class4_Sub20_Sub1 extends Class4_Sub20 {
	public static Class26 aClass26_2731;
	public static Class26 aClass26_2733 = RS2Font.getRs2PreparedString(" x ",
			false);
	public static Class26 aClass26_2738;
	public static Class26 aClass26_2746;
	...
	public static volatile int anInt2703;
	...
	static {
		aClass26_2738 = RS2Font.getRs2PreparedString("", false);
		aClass26_2746 = RS2Font.getRs2PreparedString(
				"This world is running a closed Beta)3", false);
		anInt2734 = 0;
		aClass26_2731 = aClass26_2746;
		anInt2703 = 0;
	}
	...
	public Class26 aClass26_2713;
	public Class26[] aClass26Array2716;
	...
	public Class4_Sub20_Sub1() {
		...
		anInt2725 = 1;
		aBoolean2729 = false;
		aClass26_2713 = Class4_Sub21.aClass26_2372;
		anInt2710 = -1;
		anInt2720 = 0;
		anInt2705 = 0;
		aBoolean2730 = false;
		...
		anInt2711 = -1;
		anInt2747 = -1;
		aClass26Array2716 = new Class26[5];
		anInt2744 = 1;
		anInt2745 = -1;
		aBoolean2754 = false;
		anInt2743 = 0;
		...
		if (arg1 >= 91) {
			if (arg2 != 1) {
				if ((arg2 ^ 0xffffffff) == -3)
					aClass26_2713 = arg0.method212(78);
				else if (arg2 == 5) {
					int i = arg0.get();
					if (i > 0) {
							...
							if (arg2 == 27)
								...
								if ((arg2 ^ 0xffffffff) == -30)
									...
									if (arg2 < 30 || (arg2 ^ 0xffffffff) <= -36) {
										...
										aClass26Array2716[-30 + arg2] = arg0
												.method212(80);
										if (aClass26Array2716[-30 + arg2]
												.method818(
														Class28.aClass26_638,
														(byte) -105))
											aClass26Array2716[arg2 + -30] = null;
									}
								} else
	...
	public void method332(int arg0) {
		...
		if (anInt2726 == -1) {
			...
			for (int i_6_ = 0; (i_6_ ^ 0xffffffff) > -6; i_6_++) {
				if (aClass26Array2716[i_6_] != null)
					anInt2726 = 1;
			}
		}
		if (anInt2747 == -1)
