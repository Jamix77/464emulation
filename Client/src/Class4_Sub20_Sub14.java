...
public class Class4_Sub20_Sub14 extends Class4_Sub20 {
	...
	public static Class26 aClass26_3135 = RS2Font.getRs2PreparedString(
			"Keine Antwort vom Server)3", false);
	public static Class26 aClass26_3136;
	public static Class26 aClass26_3137;
	public static Class26 aClass26_3145;
	public static Class26 aClass26_3147;
	public static Class26 aClass26_3148;
	...
	static {
		aClass26_3137 = RS2Font
				.getRs2PreparedString("Wordpack geladen)3", false);
		aClass26_3145 = RS2Font.getRs2PreparedString("Einloggen", false);
		aClass26_3148 = RS2Font.getRs2PreparedString("Unable to connect)3",
				false);
		aClass26_3136 = aClass26_3148;
		aClass26_3147 = aClass26_3148;
	}
		...
		try {
			...
			for (int i_14_ = 0; i_14_ < 4; i_14_++) {
				...
				for (int i_27_ = 0; (i_27_ ^ 0xffffffff) > -105; i_27_++) {
					...
					Class26.anIntArray1798[i_27_] = 0;
				}
					...
					if ((i_28_ ^ 0xffffffff) <= -2
						...
						for (int i_39_ = -5; (i_39_ ^ 0xffffffff) > -110; i_39_++) {
							...
							if (i_41_ >= 0 && i_41_ < 104) {
								...
								i_37_ += Class26.anIntArray1798[i_41_];
							}
							if (i_40_ >= 0 && i_40_ < 104) {
								...
								i_37_ -= Class26.anIntArray1798[i_40_];
							}
