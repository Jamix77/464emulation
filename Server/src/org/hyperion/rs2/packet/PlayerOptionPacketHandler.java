...
public class PlayerOptionPacketHandler implements PacketHandler {
	...
	private static final int OPTION_ATTACK = 84, OPTION_2 = 37, OPTION_3 = 185, OPTION_4 = 183, OPTION_SPELL = 123;
	...
	private void optionSpell(Player player, Packet packet) {
		int id = packet.getByteC();
		packet.getShortA();
		int interfaceValue = packet.getLEShortA();
