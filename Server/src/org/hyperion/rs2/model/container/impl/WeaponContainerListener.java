...
public class WeaponContainerListener implements ContainerListener {
	...
	private void sendWeapon() {
		...
		if (weapon != null && weapon.getEquipmentDefinition() != null) {
			...
			player.setTurn90CounterClockwiseAnimation(weapon.getEquipmentDefinition().getAnimation().getTurn90CounterClockWise());
		} else {
	...
	private void sendWeapon(int id, String originalName, String name, String genericName) {
		if (name.equals("unarmed")) {
			...
			player.getActionSender().sendSidebarInterface(86, 92);
			player.getActionSender().sendString(92, 0, originalName);
		} else if (name.endsWith("chinchompa")) {
			switch (player.getCombatState().getCombatStyle()) {
				case ACCURATE :
				case CONTROLLED_1 :
			...
			player.getActionSender().sendSidebarInterface(86, 473);
			player.getActionSender().sendString(473, 0, originalName);
			player.getActionSender().sendInterfaceConfig(473, 10, true);
			...
			player.getActionSender().sendSidebarInterface(86, 93);
			...
			player.getActionSender().sendSidebarInterface(86, 86);
			...
			player.getActionSender().sendSidebarInterface(86, 77);
			...
			player.getActionSender().sendSidebarInterface(86, 79);
			...
			player.getActionSender().sendSidebarInterface(86, 81);
			...
			player.getActionSender().sendSidebarInterface(86, 90);
			...
			player.getActionSender().sendSidebarInterface(86, 91);
			...
			player.getActionSender().sendSidebarInterface(86, 88);
			...
			player.getActionSender().sendSidebarInterface(86, 89);
			...
			player.getActionSender().sendSidebarInterface(86, 83);
			...
			player.getActionSender().sendSidebarInterface(86, 76);
			...
			player.getActionSender().sendSidebarInterface(86, 82);
			...
			player.getActionSender().sendSidebarInterface(86, 75);
			...
			player.getActionSender().sendSidebarInterface(86, 78);
			...
			player.getActionSender().sendSidebarInterface(86, 84);
			...
			player.getActionSender().sendSidebarInterface(86, 87);
	...
	private void setSpecials(int weaponId) {
		...
		} else if (weaponId == 1215 || weaponId == 1231 || weaponId == 5680 || weaponId == 5698 || weaponId == 8872 || weaponId == 8874 || weaponId == 8876 || weaponId == 8878) {
			player.getActionSender().sendInterfaceConfig(89, 12, false);
		} else if (weaponId == 35 || weaponId == 1305 || weaponId == 4587 || weaponId == 6746 || weaponId == 11037) {
			player.getActionSender().sendInterfaceConfig(81, 12, false);
		} else if (weaponId == 7158 || weaponId == 11694 || weaponId == 11696 || weaponId == 11698 || weaponId == 11700 || weaponId == 11730) {
			player.getActionSender().sendInterfaceConfig(82, 12, false);
		} else if (weaponId == 859 || weaponId == 861 || weaponId == 6724 || weaponId == 10284 || weaponId == 11235) {
	...
	private String filterWeaponName(String name) {
		final String[] filtered = new String[]{"Iron", "Steel", "Scythe", "Black", "Mithril", "Adamant", "Rune", "Granite", "Dragon", "Crystal", "Bronze", "Drag"};
