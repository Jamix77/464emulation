...
public class DialogueManager {
	...
	public static void openDialogue(Player player, int dialogueId) {
		...
		case 215:
			...
			player.getInterfaceState().setNextDialogueId(1, 219);
			player.getInterfaceState().setNextDialogueId(2, 221);
			break;
		case 216:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Do you want to trade?");
			player.getInterfaceState().setNextDialogueId(0, 217);
			break;
		case 217://zeke weapon shop
			player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.HAPPY,
					"Yes, certainly. I deal in scimitars.");
		...
		case 218:
			...
			break;
		case 219:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Nice cloak.");
		...
		case 220:
			...
			break;
		case 221:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Could you sell me a dragon scimitar?");
			player.getInterfaceState().setNextDialogueId(0, 222);
			break;
		case 222:
			player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.CALM_2,
					"A dragon scimitar? A DRAGON scimitar?");
		...
		case 225:
			...
			break;	
		case 226:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.HAPPY, "Hmmm, funny you should say that...");
		...
		case 228:
			...
			break;
		case 229:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Not today, thank you.");
			break;
		case 230:
			player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.HAPPY,
			...
			break;
		 case 2008: 
	        	player.getActionSender().sendDialogue("Select an Option.", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "How am I doing so far?", "Who are you?", "Where are you?", "Got any tips for me?", "Nothing really.");
	        	player.getInterfaceState().setNextDialogueId(0, 2009);
	        	player.getInterfaceState().setNextDialogueId(1, 2011);
	        	player.getInterfaceState().setNextDialogueId(2, 2013);
	        	player.getInterfaceState().setNextDialogueId(3, 2015);
	        	player.getInterfaceState().setNextDialogueId(4, 2017);
	        	break;
		 case 2009:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "How am I doing so far?");
			 player.getInterfaceState().setNextDialogueId(0, 2010);
			 break;
		 case 2011:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Who are you?");
			 player.getInterfaceState().setNextDialogueId(0, 2012);
			 break;
		 case 2013:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Where are you?");
			 player.getInterfaceState().setNextDialogueId(0, 2014);
			 break;
		 case 2015:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Got any tips for me?");
			 player.getInterfaceState().setNextDialogueId(0, 2016);
			 break;
		 case 2017:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Nothing really.");
			 player.getInterfaceState().setNextDialogueId(0, -1);
			 break;
		 case 2018: 
			 player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.HAPPY, "'Ello, and what are you after then?");
			 player.getInterfaceState().setNextDialogueId(0, 2019);
			 break;
		 case 2019: 
			 player.getActionSender().sendDialogue("Select an option.", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "I need another assignment", "Do you have anything for trade?", "Purchase a new Master", "Er...nothing");
			 player.getInterfaceState().setNextDialogueId(0, 2020);
			 break;
		 case 2300:
			 player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.HAPPY, "Hello " +player.getName() + ", where can I take you?");
			 player.getInterfaceState().setNextDialogueId(0, 2301);
			 break;
		 case 2301:
			 player.getActionSender().sendDialogue("Select an area.", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Edgeville", "Al-Kharid", "Rellekka", "More...");
			 player.getInterfaceState().setNextDialogueId(0, 2302);
			 player.getInterfaceState().setNextDialogueId(1, 2304);
			 player.getInterfaceState().setNextDialogueId(2, 2306);
			 player.getInterfaceState().setNextDialogueId(3, 2308);
			 break;
		 case 2302:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Edgeville please.");
			 player.getInterfaceState().setNextDialogueId(0, 2303);
			 break;
		 case 2303:
			 player.setTeleportTarget(Location.create(3101, 3486, 0));//Location for edge
			 player.getActionSender().removeAllInterfaces();
			 break;
		 case 2304:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Al-Kharid please.");
			 player.getInterfaceState().setNextDialogueId(0, 2305);
			 break;
		 case 2305:
			 player.setTeleportTarget(Location.create(3293, 3175, 0));//Location for al-kharid\
			 player.setDirection(WalkingQueue.NORTH);
			 player.getActionSender().removeAllInterfaces();
			 break;
		 case 2306:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Rellekka please.");
			 player.getInterfaceState().setNextDialogueId(0, 2307);
			 break;
		 case 2307:
			 player.setTeleportTarget(Location.create(2648, 3710, 0));//Location for Rellekka
			 player.getActionSender().removeAllInterfaces();
			 break;
		 case 2308:
			 player.getActionSender().sendDialogue("Select an area.", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Canifis", "Back...");
			 player.getInterfaceState().setNextDialogueId(0, 2309);
			 player.getInterfaceState().setNextDialogueId(1, 2301);
			 break;
		 case 2309:
			 player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Canifis please.");
			 player.getInterfaceState().setNextDialogueId(0, 2307);
			 break;
		 case 2310:
			 player.setTeleportTarget(Location.create(3423, 3485, 0));//Location for Canifis
			 player.getActionSender().removeAllInterfaces();
			 break;
		case 97:
		case 98:
