...
import org.hyperion.rs2.model.equipment.PoisonType;
import org.hyperion.rs2.tickable.Tickable;
import org.hyperion.rs2.tickable.impl.SkillsUpdateTick;
...
public class MagicCombatAction extends AbstractCombatAction {
	...
	public static void executeSpell(final Spell spell, final Mob mob, Object... args) {
		...
		if(spell == Spell.HOME_TELEPORT_MODERN || spell == Spell.HOME_TELEPORT_LUNAR || spell == Spell.HOME_TELEPORT_ANCIENT) {
			...
			mob.getActionQueue().addAction(new Action(mob, 19) {
				...
				@Override
				public void execute() {
					if(spell == Spell.HOME_TELEPORT_ANCIENT) {
						mob.setTeleportTarget(Location.create(3087, 3490, 0));
					} else {
