...
import org.hyperion.rs2.tickable.impl.PoisonDrainTick;
import org.hyperion.rs2.tickable.impl.SkillsUpdateTick;
import org.hyperion.rs2.tickable.impl.SpecialEnergyRestoreTick;
						...
						for (Mob mob : getRegion().getMobs()) {
							if (!mob.getCombatState().isDead()) {
								...
								if (mob.getLocation().isNextTo(getLocation())
									...
									int dmg = random.nextInt((int) (getSkills()
