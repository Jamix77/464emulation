...
public class ItemDefinition {
	...
	public static void init() throws IOException {
		...
		try {
			...
			for(int i = 0; i < count; i++) {				
				...
				definitions[id] = new ItemDefinition(id, name, examine, noted, noteable, stackable, parentId, notedId, members, shopValue, weight);
			}
	...
	public static void dump() {
		try {
			...
			OutputStream os = new FileOutputStream("data/itemDefinitions-weights.bin");
	 ...
	 */
	private ItemDefinition(int id, String name, String examine, boolean noted, boolean noteable, boolean stackable, int parentId, int notedId, boolean members, int shopValue, double weight) {
		this.id = id;
		this.name = name;
